! function(t) {
    ...
    (e = function() {
        ...
        var s, n, o, r = this,
            a = t(e.currentTarget);
        switch (a.is("a") && e.preventDefault(), a.is("li") || (a = a.closest("li")), s = (o = r.slideCount % r.options.slidesToScroll != 0) ? 0 : (r.slideCount - r.currentSlide) % r.options.slidesToScroll, e.data.message) {
            case "previous":
        ...
        var e, i, s, n = this;
        return s = !0 === n.options.centerMode ? n.slideWidth * Math.floor(n.options.slidesToShow / 2) : 0, !0 === n.options.swipeToSlide ? (n.$slideTrack.find(".slick-slide").each((function(e, o) {
    ...
    function(t) {
        ...
        if (!t.jQuery) {
            ...
            $.isWindow = function(t) {
                ...
                if (s) {
                    if (a)
                        for (; r > o && !1 !== (n = i.apply(t[o], s)); o++);
                    else
                        for (o in t)
                            if (!1 === (n = i.apply(t[o], s))) break
                } else if (a)
                    for (; r > o && !1 !== (n = i.call(t[o], o, t[o])); o++);
                else
                    for (o in t)
                        if (!1 === (n = i.call(t[o], o, t[o]))) break;
                return t
            }, $.data = function(t, e, s) {
                if (void 0 === s) {
                    var n, o = (n = t[$.expando]) && i[n];
                    if (void 0 === e) return o;
                    if (o && e in o) return o[e]
                } else if (void 0 !== e) {
                    var n = t[$.expando] || (t[$.expando] = ++$.uuid);
                    return i[n] = i[n] || {}, i[n][e] = s, s
                }
                ...
                var t, e, i, s, n, o, r = arguments[0] || {},
                    ...
                    l = arguments.length,
                    c = !1;
                for ("boolean" == typeof r && (c = r, r = arguments[a] || {}, a++), "object" != typeof r && "function" !== $.type(r) && (r = {}), a === l && (r = this, a--); l > a; a++)
                    if (null != (n = arguments[a]))
                        for (s in n) t = r[s], r !== (i = n[s]) && (c && i && ($.isPlainObject(i) || (e = $.isArray(i))) ? (e ? (e = !1, o = t && $.isArray(t) ? t : []) : o = t && $.isPlainObject(t) ? t : {}, r[s] = $.extend(c, o, i)) : void 0 !== i && (r[s] = i));
                return r
                ...
                if (t) {
                    i = (i || "fx") + "queue";
                    var o = $.data(t, i);
                    return s ? (!o || $.isArray(s) ? o = $.data(t, i, n(s)) : o.push(s), o) : o || []
                }
                ...
                $.each(t.nodeType ? [t] : t, (function(t, i) {
                    ...
                    var s = $.queue(i, e),
                        n = s.shift();
                    "inprogress" === n && (n = s.shift()), n && ("fx" === e && s.unshift("inprogress"), n.call(i, (function() {
                        $.dequeue(i, e)
                    })))
                }))
            }, $.fn = $.prototype = {
                ...
                position: function() {
                    ...
                    return i.top -= parseFloat(e.style.marginTop) || 0, i.left -= parseFloat(e.style.marginLeft) || 0, t.style && (s.top += parseFloat(t.style.borderTopWidth) || 0, s.left += parseFloat(t.style.borderLeftWidth) || 0), {
                        top: i.top - s.top,
                        left: i.left - s.left
                    }
                }
            ...
            for (var s = {}, n = s.hasOwnProperty, o = s.toString, r = "Boolean Number String Function Array Date RegExp Object Error".split(" "), a = 0; a < r.length; a++) s["[object " + r[a] + "]"] = r[a].toLowerCase();
    ...
    function(t) {
        ...
        return function(t, e, i, s) {
            ...
            function l(t, i, s, n) {
                ...
                function l(t, e, i) {
                    return ((o(e, i) * t + r(e, i)) * t + a(e)) * t
                }

                function c(t, e, i) {
                    return 3 * o(e, i) * t * t + 2 * r(e, i) * t + a(e)
                }
                ...
                function h() {
                    for (var e = 0; y > e; ++e) C[e] = l(e * b, t, s)
                }

                function d(e, i, n) {
                    var o, r, a = 0;
                    do {
                        (o = l(r = i + (n - i) / 2, t, s) - e) > 0 ? n = r : i = r
                    } while (Math.abs(o) > v && ++a < _);
                    return r
                }

                function p(e) {
                    for (var i = 0, n = 1, o = y - 1; n != o && C[n] <= e; ++n) i += b;
                    --n;
                    var r, a = i + (e - C[n]) / (C[n + 1] - C[n]) * b,
                        l = c(a, t, s);
                    return l >= g ? u(e, a) : 0 == l ? a : d(e, i, i + b)
                }
                ...
                var C = w ? new Float32Array(y) : new Array(y),
                    x = !1,
                    T = function(e) {
                        return x || f(), t === i && s === n ? e : 0 === e ? 0 : 1 === e ? 1 : l(p(e), i, n)
                    };
            ...
            function c(t, e) {
                var i = t;
                return f.isString(t) ? _.Easings[t] || (i = !1) : i = f.isArray(t) && 1 === t.length ? a.apply(null, t) : f.isArray(t) && 2 === t.length ? y.apply(null, t.concat([e])) : !(!f.isArray(t) || 4 !== t.length) && l.apply(null, t), !1 === i && (i = _.Easings[_.defaults.easing] ? _.defaults.easing : v), i
            }
                    ...
                    for (var o = 0; i > o; o++)
                        if (_.State.calls[o]) {
                            var a = _.State.calls[o],
                                ...
                                p = !!d,
                                m = null;
                            d || (d = _.State.calls[o][3] = e - 16);
                            for (var g = Math.min((e - d) / c.duration, 1), v = 0, y = l.length; y > v; v++) {
                                var w = l[v],
                                    C = w.element;
                                if (r(C)) {
                                    var x = !1;
                                    if (c.display !== s && null !== c.display && "none" !== c.display) {
                                        if ("flex" === c.display) {
                                        ...
                                        b.setPropertyValue(C, "display", c.display)
                                    }
                                    for (var D in c.visibility !== s && "hidden" !== c.visibility && b.setPropertyValue(C, "visibility", c.visibility), w)
                                        if ("element" !== D) {
                                            var S = w[D],
                                                I, P = f.isString(S.easing) ? _.Easings[S.easing] : S.easing;
                                            if (1 === g) I = S.endValue;
                                            else {
                                                var A = S.endValue - S.startValue;
                                                if (I = S.startValue + A * P(g, c, A), !p && I === S.currentValue) continue
                                            }
                                            if (S.currentValue = I, "tween" === D) m = I;
                                            else {
                                                if (b.Hooks.registered[D]) {
                                                    var E = b.Hooks.getRoot(D),
                                                        M = r(C).rootPropertyValueCache[E];
                                                    M && (S.rootPropertyValue = M)
                                                }
                                                var O = b.setPropertyValue(C, D, S.currentValue + (0 === parseFloat(I) ? "" : S.unitType), S.rootPropertyValue, S.scrollData);
                                                b.Hooks.registered[D] && (r(C).rootPropertyValueCache[E] = b.Normalizations.registered[E] ? b.Normalizations.registered[E]("extract", null, O[1]) : O[1]), "transform" === O[0] && (x = !0)
                                            }
                                        }
                                    c.mobileHA && r(C).transformCache.translate3d === s && (r(C).transformCache.translate3d = "(0px, 0px, 0px)", x = !0), x && b.flushTransformCache(C)
                                }
                            }
                            c.display !== s && "none" !== c.display && (_.State.calls[o][2].display = !1), c.visibility !== s && "hidden" !== c.visibility && (_.State.calls[o][2].visibility = !1), c.progress && c.progress.call(a[1], a[1], g, Math.max(0, d + c.duration - e), d, m), 1 === g && h(o)
                        }
                }
                _.State.isTicking && k(u)
            }

            function h(t, e) {
                if (!_.State.calls[t]) return !1;
                for (var i = _.State.calls[t][0], n = _.State.calls[t][1], o = _.State.calls[t][2], a = _.State.calls[t][4], l = !1, c = 0, u = i.length; u > c; c++) {
                    var h = i[c].element;
                    if (e || o.loop || ("none" === o.display && b.setPropertyValue(h, "display", o.display), "hidden" === o.visibility && b.setPropertyValue(h, "visibility", o.visibility)), !0 !== o.loop && ($.queue(h)[1] === s || !/\.velocityQueueEntryFlag/i.test($.queue(h)[1])) && r(h)) {
                        r(h).isAnimating = !1, r(h).rootPropertyValueCache = {};
                        var d = !1;
                        $.each(b.Lists.transforms3D, (function(t, e) {
                            var i = /^scale/.test(e) ? 1 : 0,
                                n = r(h).transformCache[e];
                            r(h).transformCache[e] !== s && new RegExp("^\\(" + i + "[^.]").test(n) && (d = !0, delete r(h).transformCache[e])
                        })), o.mobileHA && (d = !0, delete r(h).transformCache.translate3d), d && b.flushTransformCache(h), b.Values.removeClass(h, "velocity-animating")
                    }
                    ...
                    a && !0 !== o.loop && a(n), !0 !== o.loop || e || ($.each(r(h).tweensContainer, (function(t, e) {
                        /^rotate/.test(t) && 360 === parseFloat(e.endValue) && (e.endValue = 0, e.startValue = 360), /^backgroundPosition/.test(t) && 100 === parseFloat(e.endValue) && "%" === e.unitType && (e.endValue = 0, e.startValue = 100)
                    })), _(h, "reverse", {
                        loop: !0,
                        delay: o.delay
                    })), !1 !== o.queue && $.dequeue(h, o.queue)
                }
                _.State.calls[t] = !1;
                for (var p = 0, f = _.State.calls.length; f > p; p++)
                    if (!1 !== _.State.calls[p]) {
                        l = !0;
                        break
            ...
            var d = function() {
                ...
                p = function() {
                    ...
                    return e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || function(e) {
                        var i = (new Date).getTime(),
                            s;
                        return s = Math.max(0, 16 - (i - t)), t = i + s, setTimeout((function() {
                            e(i + s)
                        }), s)
                    }
                }(),
                ...
                $, m = !1;
            if (t.fn && t.fn.jquery ? ($ = t, m = !0) : $ = e.Velocity.Utilities, 8 >= d && !m) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
            if (!(7 >= d)) {
                var g = 400,
                    v = "swing",
                    _ = {
                ...
                e.pageYOffset !== s ? (_.State.scrollAnchor = e, _.State.scrollPropertyLeft = "pageXOffset", _.State.scrollPropertyTop = "pageYOffset") : (_.State.scrollAnchor = i.documentElement || i.body.parentNode || i.body, _.State.scrollPropertyLeft = "scrollLeft", _.State.scrollPropertyTop = "scrollTop");
                var y = function() {
                    function t(t) {
                    ...
                    return function t(e, s, n) {
                        var o = {
                            ...
                            c = .016,
                            u, h, d;
                        for (e = parseFloat(e) || 500, s = parseFloat(s) || 20, n = n || null, o.tension = e, o.friction = s, (u = null !== n) ? h = (a = t(e, s)) / n * c : h = c; d = i(d || o, h), r.push(1 + d.x), a += 16, Math.abs(d.x) > l && Math.abs(d.v) > l;);
                        return u ? function(t) {
                ...
                var b = _.CSS = {
                    ...
                    Hooks: {
                        ...
                        register: function() {
                            ...
                            for (i in b.Hooks.templates)
                                for (var t in n = (s = b.Hooks.templates[i])[0].split(" ")) {
                                    var r = i + n[t],
                                        a = t;
                        ...
                        extractValue: function(t, e) {
                            ...
                            if (i) {
                                var s = i[0],
                                    n = i[1];
                                return (e = b.Hooks.cleanRootPropertyValue(s, e)).toString().match(b.RegEx.valueSplit)[n]
                            }
                            return e
                        },
                        injectValue: function(t, e, i) {
                            var s = b.Hooks.registered[t];
                            if (s) {
                                var n = s[0],
                                    o = s[1],
                                    r, a;
                                return (r = (i = b.Hooks.cleanRootPropertyValue(n, i)).toString().match(b.RegEx.valueSplit))[o] = e, r.join(" ")
                            }
                            return i
                        }
                    },
                    Normalizations: {
                        ...
                        register: function() {
                            ...
                            for (var t = 0; t < b.Lists.transformsBase.length; t++) ! function() {
                                ...
                                b.Normalizations.registered[e] = function(t, i, n) {
                                    switch (t) {
                                        case "name":
                                            return "transform";
                                        case "extract":
                                            return r(i) === s || r(i).transformCache[e] === s ? /^scale/i.test(e) ? 1 : 0 : r(i).transformCache[e].replace(/[()]/g, "");
                                        case "inject":
                                            var o = !1;
                                            switch (e.substr(0, e.length - 1)) {
                                                ...
                                                case "scal":
                                                case "scale":
                                                    _.State.isAndroid && r(i).transformCache[e] === s && 1 > n && (n = 1), o = !/(\d)$/i.test(n);
                                                    break;
                                                case "skew":
                                                case "rotate":
                                                    o = !/(deg|\d)$/i.test(n)
                                            }
                                            return o || (r(i).transformCache[e] = "(" + n + ")"), r(i).transformCache[e]
                                    }
                                }
                            }();
                                    ...
                                    switch (t) {
                                        ...
                                        case "extract":
                                            ...
                                            if (b.RegEx.wrappedValueAlreadyExtracted.test(n)) o = n;
                                                ...
                                                /^[A-z]+$/i.test(n) ? r = a[n] !== s ? a[n] : a.black : b.RegEx.isHex.test(n) ? r = "rgb(" + b.Values.hexToRgb(n).join(" ") + ")" : /^rgba?\(/i.test(n) || (r = a.black), o = (r || n).toString().match(b.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                            }
                    ...
                    Names: {
                        ...
                        prefixCheck: function(t) {
                            ...
                            for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, s = e.length; s > i; i++) {
                                ...
                                })), f.isString(_.State.prefixElement.style[n])) return _.State.prefixMatches[t] = n, [n, !0]
                            }
                            return [t, !1]
                        }
                    },
                    Values: {
                        hexToRgb: function(t) {
                            var e = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
                                ...
                                s;
                            return t = t.replace(e, (function(t, e, i, s) {
                                return e + e + i + i + s + s
                            })), (s = i.exec(t)) ? [parseInt(s[1], 16), parseInt(s[2], 16), parseInt(s[3], 16)] : [0, 0, 0]
                        },
                    ...
                    getPropertyValue: function(t, i, n, o) {
                        function a(t, i) {
                            ...
                            if (8 >= d) l = $.css(t, i);
                                ...
                                var c = !1,
                                    u;
                                if (/^(width|height)$/.test(i) && 0 === b.getPropertyValue(t, "display") && (c = !0, b.setPropertyValue(t, "display", b.Values.getDisplayType(t))), !o) {
                                    if ("height" === i && "border-box" !== b.getPropertyValue(t, "boxSizing").toString().toLowerCase()) {
                                        var h = t.offsetHeight - (parseFloat(b.getPropertyValue(t, "borderTopWidth")) || 0) - (parseFloat(b.getPropertyValue(t, "borderBottomWidth")) || 0) - (parseFloat(b.getPropertyValue(t, "paddingTop")) || 0) - (parseFloat(b.getPropertyValue(t, "paddingBottom")) || 0);
                                        return n(), h
                                    }
                                ...
                                u = r(t) === s ? e.getComputedStyle(t, null) : r(t).computedStyle ? r(t).computedStyle : r(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === i && (i = "borderTopColor"), ("" === (l = 9 === d && "filter" === i ? u.getPropertyValue(i) : u[i]) || null === l) && (l = t.style[i]), n()
                            }
                            if ("auto" === l && /^(top|right|bottom|left)$/i.test(i)) {
                                var f = a(t, "position");
                                ("fixed" === f || "absolute" === f && /top|left/i.test(i)) && (l = $(t).position()[i] + "px")
                            }
                            return l
                        }
                        var l;
                        if (b.Hooks.registered[i]) {
                            var c = i,
                                u = b.Hooks.getRoot(c);
                            n === s && (n = b.getPropertyValue(t, b.Names.prefixCheck(u)[0])), b.Normalizations.registered[u] && (n = b.Normalizations.registered[u]("extract", t, n)), l = b.Hooks.extractValue(c, n)
                        } else if (b.Normalizations.registered[i]) {
                            var h, p;
                            "transform" !== (h = b.Normalizations.registered[i]("name", t)) && (p = a(t, b.Names.prefixCheck(h)[0]), b.Values.isCSSNullValue(p) && b.Hooks.templates[i] && (p = b.Hooks.templates[i][1])), l = b.Normalizations.registered[i]("extract", t, p)
                        }
                        if (!/^[\d-]/.test(l))
                            if (r(t) && r(t).isSVG && b.Names.SVGAttribute(i))
                                if (/^(height|width)$/i.test(i)) try {
                                    l = t.getBBox()[i]
                                } catch (t) {
                                    l = 0
                                } else l = t.getAttribute(i);
                            else l = a(t, b.Names.prefixCheck(i)[0]);
                        return b.Values.isCSSNullValue(l) && (l = 0), _.debug >= 2 && console.log("Get " + i + ": " + l), l
                    },
                    setPropertyValue: function(t, i, s, n, o) {
                        var a = i;
                        if ("scroll" === i) o.container ? o.container["scroll" + o.direction] = s : "Left" === o.direction ? e.scrollTo(s, o.alternateValue) : e.scrollTo(o.alternateValue, s);
                        else if (b.Normalizations.registered[i] && "transform" === b.Normalizations.registered[i]("name", t)) b.Normalizations.registered[i]("inject", t, s), a = "transform", s = r(t).transformCache[i];
                        else {
                            if (b.Hooks.registered[i]) {
                                var l = i,
                                    c = b.Hooks.getRoot(i);
                                n = n || b.getPropertyValue(t, c), s = b.Hooks.injectValue(l, s, n), i = c
                            }
                            if (b.Normalizations.registered[i] && (s = b.Normalizations.registered[i]("inject", t, s), i = b.Normalizations.registered[i]("name", t)), a = b.Names.prefixCheck(i)[0], 8 >= d) try {
                                t.style[a] = s
                            } catch (t) {
                                _.debug && console.log("Browser does not support [" + s + "] for [" + a + "]")
                            } else r(t) && r(t).isSVG && b.Names.SVGAttribute(i) ? t.setAttribute(i, s) : t.style[a] = s;
                    ...
                    flushTransformCache: function(t) {
                        ...
                        var i = "";
                        if ((d || _.State.isAndroid && !_.State.isChrome) && r(t).isSVG) {
                            var s = {
                            ...
                            $.each(r(t).transformCache, (function(t) {
                                /^translate/i.test(t) ? t = "translate" : /^scale/i.test(t) ? t = "scale" : /^rotate/i.test(t) && (t = "rotate"),
                                s[t] && (i += t + "(" + s[t].join(" ") + ") ", delete s[t])
                            }))
                        } else {
                            var n, o;
                            $.each(r(t).transformCache, (function(e) {
                                return n = r(t).transformCache[e], "transformPerspective" === e ? (o = n, !0) : (9 === d && "rotateZ" === e && (e = "rotate"), void(i += e + n + " "))
                            })), o && (i = "perspective" + o + " " + i)
                        }
                        b.setPropertyValue(t, "transform", i)
                    }
                };
                b.Hooks.register(), b.Normalizations.register(), _.hook = function(t, e, i) {
                    var n = s;
                    return t = o(t), $.each(t, (function(t, o) {
                        if (r(o) === s && _.init(o), i === s) n === s && (n = _.CSS.getPropertyValue(o, e));
                        else {
                            var a = _.CSS.setPropertyValue(o, e, i);
                            "transform" === a[0] && _.CSS.flushTransformCache(o), n = a
                        }
                    })), n
                };
                var w = function() {
                    function t() {
                        return l ? D.promise || null : d
                    }
                    ...
                    function n() {
                        function t(t) {
                            function h(t, e) {
                                var i = s,
                                    r = s,
                                    a = s;
                                return f.isArray(t) ? (i = t[0], !f.isArray(t[1]) && /^[\d-]/.test(t[1]) || f.isFunction(t[1]) || b.RegEx.isHex.test(t[1]) ? a = t[1] : (f.isString(t[1]) && !b.RegEx.isHex.test(t[1]) || f.isArray(t[1])) && (r = e ? t[1] : c(t[1], o.duration), t[2] !== s && (a = t[2]))) : i = t, e || (r = r || o.easing), f.isFunction(i) && (i = i.call(n, C, k)), f.isFunction(a) && (a = a.call(n, C, k)), [i || 0, r, a]
                            }
                            ...
                            function d(t, e) {
                                ...
                                return s = (e || "0").toString().toLowerCase().replace(/[%A-z]+$/, (function(t) {
                                    return i = t, ""
                                })), i || (i = b.Values.getUnitType(t)), [s, i]
                            }
                            ...
                            function p() {
                                var t = {
                                    ...
                                    s = t.position === O.lastPosition && t.myParent === O.lastParent,
                                    o = t.fontSize === O.lastFontSize;
                                O.lastParent = t.myParent, O.lastPosition = t.position, O.lastFontSize = t.fontSize;
                                var a = 100,
                                    l = {};
                                if (o && s) l.emToPx = O.lastEmToPx, l.percentToPxWidth = O.lastPercentToPxWidth, l.percentToPxHeight = O.lastPercentToPxHeight;
                                else {
                                    var c = r(n).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                                    _.init(c), t.myParent.appendChild(c), $.each(["overflow", "overflowX", "overflowY"], (function(t, e) {
                                        _.CSS.setPropertyValue(c, e, "hidden")
                                    })), _.CSS.setPropertyValue(c, "position", t.position), _.CSS.setPropertyValue(c, "fontSize", t.fontSize), _.CSS.setPropertyValue(c, "boxSizing", "content-box"), $.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], (function(t, e) {
                                        _.CSS.setPropertyValue(c, e, a + "%")
                                    })), _.CSS.setPropertyValue(c, "paddingLeft", a + "em"), l.percentToPxWidth = O.lastPercentToPxWidth = (parseFloat(b.getPropertyValue(c, "width", null, !0)) || 1) / a, l.percentToPxHeight = O.lastPercentToPxHeight = (parseFloat(b.getPropertyValue(c, "height", null, !0)) || 1) / a, l.emToPx = O.lastEmToPx = (parseFloat(b.getPropertyValue(c, "paddingLeft")) || 1) / a, t.myParent.removeChild(c)
                                }
                                return null === O.remToPx && (O.remToPx = parseFloat(b.getPropertyValue(i.body, "fontSize")) || 16), null === O.vwToPx && (O.vwToPx = parseFloat(e.innerWidth) / 100, O.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = O.remToPx, l.vwToPx = O.vwToPx, l.vhToPx = O.vhToPx, _.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), n), l
                            }
                            if (o.begin && 0 === C) try {
                                o.begin.call(m, m)
                            } catch (t) {
                            ...
                            if ("scroll" === S) {
                                var g = /^x$/i.test(o.axis) ? "Left" : "Top",
                                    w = parseFloat(o.offset) || 0,
                                    x, T, I;
                                o.container ? f.isWrapped(o.container) || f.isNode(o.container) ? (o.container = o.container[0] || o.container, I = (x = o.container["scroll" + g]) + $(n).position()[g.toLowerCase()] + w) : o.container = null : (x = _.State.scrollAnchor[_.State["scrollProperty" + g]], T = _.State.scrollAnchor[_.State["scrollProperty" + ("Left" === g ? "Top" : "Left")]], I = $(n).offset()[g.toLowerCase()] + w), a = {
                                    scroll: {
                                        rootPropertyValue: !1,
                                        startValue: x,
                                        currentValue: x,
                                    ...
                                    element: n
                                }, _.debug && console.log("tweensContainer (scroll): ", a.scroll, n)
                            } else if ("reverse" === S) {
                                if (!r(n).tweensContainer) return void $.dequeue(n, o.queue);
                                "none" === r(n).opts.display && (r(n).opts.display = "auto"), "hidden" === r(n).opts.visibility && (r(n).opts.visibility = "visible"), r(n).opts.loop = !1, r(n).opts.begin = null, r(n).opts.complete = null, y.easing || delete o.easing, y.duration || delete o.duration, o = $.extend({}, r(n).opts, o);
                                var P = $.extend(!0, {}, r(n).tweensContainer);
                                for (var A in P)
                                    if ("element" !== A) {
                                        var E = P[A].startValue;
                                        P[A].startValue = P[A].currentValue = P[A].endValue, P[A].endValue = E, f.isEmptyObject(y) || (P[A].easing = o.easing), _.debug && console.log("reverse tweensContainer (" + A + "): " + JSON.stringify(P[A]), n)
                                    }
                                a = P
                            } else if ("start" === S) {
                                var P;
                                for (var M in r(n).tweensContainer && !0 === r(n).isAnimating && (P = r(n).tweensContainer), $.each(v, (function(t, e) {
                                    if (RegExp("^" + b.Lists.colors.join("$|^") + "$").test(t)) {
                                        ...
                                        if (b.RegEx.isHex.test(n)) {
                                            for (var a = ["Red", "Green", "Blue"], l = b.Values.hexToRgb(n), c = r ? b.Values.hexToRgb(r) : s, u = 0; u < a.length; u++) {
                                                var d = [l[u]];
                                                o && d.push(o), c !== s && d.push(c[u]), v[t + a[u]] = d
                                            }
                                            delete v[t]
                                        }
                                    }
                                    ...
                                    var L = b.Hooks.getRoot(M),
                                        W = !1;
                                    if (r(n).isSVG || "tween" === L || !1 !== b.Names.prefixCheck(L)[1] || b.Normalizations.registered[L] !== s) {
                                        (o.display !== s && null !== o.display && "none" !== o.display || o.visibility !== s && "hidden" !== o.visibility) && /opacity|filter/.test(M) && !z && 0 !== H && (z = 0), o._cacheValues && P && P[M] ? (z === s && (z = P[M].endValue + P[M].unitType), W = r(n).rootPropertyValueCache[L]) : b.Hooks.registered[M] ? z === s ? (W = b.getPropertyValue(n, L), z = b.getPropertyValue(n, M, W)) : W = b.Hooks.templates[L][1] : z === s && (z = b.getPropertyValue(n, M));
                                        var Y, R, Q, q = !1;
                                        if (z = (Y = d(M, z))[0], Q = Y[1], H = (Y = d(M, H))[0].replace(/^([+-\/*])=/, (function(t, e) {
                                            return q = e, ""
                                        })), R = Y[1], z = parseFloat(z) || 0, H = parseFloat(H) || 0, "%" === R && (/^(fontSize|lineHeight)$/.test(M) ? (H /= 100, R = "em") : /^scale/.test(M) ? (H /= 100, R = "") : /(Red|Green|Blue)$/i.test(M) && (H = H / 100 * 255, R = "")), /[\/*]/.test(q)) R = Q;
                                        else if (Q !== R && 0 !== z)
                                            if (0 === H) R = Q;
                                            else {
                                                l = l || p();
                                                ...
                                                switch (Q) {
                                                    case "%":
                                                        z *= "x" === V ? l.percentToPxWidth : l.percentToPxHeight;
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                                ...
                                                switch (R) {
                                                    case "%":
                                                        z *= 1 / ("x" === V ? l.percentToPxWidth : l.percentToPxHeight);
                                                        break;
                                                    case "px":
                                                        break;
                                                    default:
                                        ...
                                        a[M] = {
                                            ...
                                            unitType: R,
                                            easing: N
                                        }, _.debug && console.log("tweensContainer (" + M + "): " + JSON.stringify(a[M]), n)
                                    } else _.debug && console.log("Skipping [" + L + "] due to a lack of browser support.")
                                }
                                a.element = n
                            }
                            a.element && (b.Values.addClass(n, "velocity-animating"), F.push(a), "" === o.queue && (r(n).tweensContainer = a, r(n).opts = o), r(n).isAnimating = !0, C === k - 1 ? (_.State.calls.push([F, m, o, null, D.resolver]), !1 === _.State.isTicking && (_.State.isTicking = !0, u())) : C++)
                        }
                        var n = this,
                            o = $.extend({}, _.defaults, y),
                            a = {},
                            l;
                        switch (r(n) === s && _.init(n), parseFloat(o.delay) && !1 !== o.queue && $.queue(n, o.queue, (function(t) {
                            _.velocityQueueEntryFlag = !0, r(n).delayTimer = {
                        ...
                        }!1 !== _.mock && (!0 === _.mock ? o.duration = o.delay = 1 : (o.duration *= parseFloat(_.mock) || 1, o.delay *= parseFloat(_.mock) || 1)), o.easing = c(o.easing, o.duration), o.begin && !f.isFunction(o.begin) && (o.begin = null), o.progress && !f.isFunction(o.progress) && (o.progress = null), o.complete && !f.isFunction(o.complete) && (o.complete = null), o.display !== s && null !== o.display && (o.display = o.display.toString().toLowerCase(), "auto" === o.display && (o.display = _.CSS.Values.getDisplayType(n))), o.visibility !== s && null !== o.visibility && (o.visibility = o.visibility.toString().toLowerCase()), o.mobileHA = o.mobileHA && _.State.isMobile && !_.State.isGingerbread, !1 === o.queue ? o.delay ? setTimeout(t, o.delay) : t() : $.queue(n, o.queue, (function(e, i) {
                            return !0 === i ? (D.promise && D.resolver(m), !0) : (_.velocityQueueEntryFlag = !0, void t(e))
                        })), "" !== o.queue && "fx" !== o.queue || "inprogress" === $.queue(n)[0] || $.dequeue(n)
                    }
                    var a = arguments[0] && (arguments[0].p || $.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || f.isString(arguments[0].properties)),
                        l, d, p, m, v, y;
                    if (f.isWrapped(this) ? (l = !1, p = 0, m = this, d = this) : (l = !0, p = 1, m = a ? arguments[0].elements || arguments[0].e : arguments[0]), m = o(m)) {
                        a ? (v = arguments[0].properties || arguments[0].p, y = arguments[0].options || arguments[0].o) : (v = arguments[p], y = arguments[p + 1]);
                        var k = m.length,
                            C = 0;
                        if (!/^(stop|finish)$/i.test(v) && !$.isPlainObject(y)) {
                            var x = p + 1;
                            y = {};
                            for (var T = x; T < arguments.length; T++) f.isArray(arguments[T]) || !/^(fast|normal|slow)$/i.test(arguments[T]) && !/^\d/.test(arguments[T]) ? f.isString(arguments[T]) || f.isArray(arguments[T]) ? y.easing = arguments[T] : f.isFunction(arguments[T]) && (y.complete = arguments[T]) : y.duration = arguments[T]
                        }
                        var D = {
                                promise: null,
                                resolver: null,
                            ...
                            S;
                        switch (l && _.Promise && (D.promise = new _.Promise((function(t, e) {
                            ...
                            case "stop":
                                ...
                                var I = [];
                                return $.each(_.State.calls, (function(t, e) {
                                    e && $.each(e[1], (function(i, n) {
                                        var o = y === s ? "" : y;
                                        return !0 !== o && e[2].queue !== o && (y !== s || !1 !== e[2].queue) || void $.each(m, (function(i, s) {
                                            s === n && ((!0 === y || f.isString(y)) && ($.each($.queue(s, f.isString(y) ? y : ""), (function(t, e) {
                                                f.isFunction(e) && e(null, !0)
                                            })), $.queue(s, f.isString(y) ? y : "", [])), "stop" === v ? (r(s) && r(s).tweensContainer && !1 !== o && $.each(r(s).tweensContainer, (function(t, e) {
                                                e.endValue = e.currentValue
                                            })), I.push(t)) : "finish" === v && (e[2].duration = 1))
                                        }))
                                    }))
                                })), "stop" === v && ($.each(I, (function(t, e) {
                                    h(e, !0)
                                })), D.promise && D.resolver(m)), t();
                            default:
                                if (!$.isPlainObject(v) || f.isEmptyObject(v)) {
                                    if (f.isString(v) && _.Redirects[v]) {
                                        var P, A = (P = $.extend({}, y)).duration,
                                            E = P.delay || 0;
                                        return !0 === P.backwards && (m = $.extend(!0, [], m).reverse()), $.each(m, (function(t, e) {
                                            parseFloat(P.stagger) ? P.delay = E + parseFloat(P.stagger) * t : f.isFunction(P.stagger) && (P.delay = E + P.stagger.call(e, t, k)), P.drag && (P.duration = parseFloat(A) || (/^(callout|transition)/.test(v) ? 1e3 : g), P.duration = Math.max(P.duration * (P.backwards ? 1 - t / k : (t + 1) / k), .75 * P.duration, 200)), _.Redirects[v].call(e, e, P || {}, t, k, m, D.promise ? D : s)
                                        })), t()
                                    }
                                    var M = "Velocity: First argument (" + v + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                    return D.promise ? D.rejecter(new Error(M)) : console.log(M), t()
                                }
                                S = "start"
                        }
                        var O = {
                            ...
                            F = [],
                            P, j;
                        if ($.each(m, (function(t, e) {
                            f.isNode(e) && n.call(e)
                        })), (P = $.extend({}, _.defaults, y)).loop = parseInt(P.loop), j = 2 * P.loop - 1, P.loop)
                            for (var H = 0; j > H; H++) {
                                var N = {
                                    delay: P.delay,
                                    progress: P.progress
                                };
                                H === j - 1 && (N.display = P.display, N.visibility = P.visibility, N.complete = P.complete), w(m, "reverse", N)
                            }
                        return t()
                    }
                };
                (_ = $.extend(w, _)).animate = w;
                var k = e.requestAnimationFrame || p;
                return _.State.isMobile || i.hidden === s || i.addEventListener("visibilitychange", (function() {
                    i.hidden ? (k = function(t) {
                        return setTimeout((function() {
                            t(!0)
                        }), 16)
                    }, u()) : k = e.requestAnimationFrame || p
                })), t.Velocity = _, t !== e && (t.fn.velocity = w, t.fn.velocity.defaults = _.defaults), $.each(["Down", "Up"], (function(t, e) {
                    _.Redirects["slide" + e] = function(t, i, n, o, r, a) {
                        var l = $.extend({}, i),
                            c = l.begin,
                            u = l.complete,
                            h = {
                            ...
                            d = {};
                        l.display === s && (l.display = "Down" === e ? "inline" === _.CSS.Values.getDisplayType(t) ? "inline-block" : "block" : "none"), l.begin = function() {
                            for (var i in c && c.call(r, r), h) {
                                d[i] = t.style[i];
                                var s = _.CSS.getPropertyValue(t, i);
                                h[i] = "Down" === e ? [s, 0] : [0, s]
                            }
                    ...
                    _.Redirects["fade" + e] = function(t, i, n, o, r, a) {
                        var l = $.extend({}, i),
                            c = {
                                opacity: "In" === e ? 1 : 0
                            },
                        ...
                        l.complete = n !== o - 1 ? l.begin = null : function() {
                            u && u.call(r, r), a && a.resolver(r)
                        }, l.display === s && (l.display = "In" === e ? "auto" : "none"), _(this, c, l)
                    }
                })), _
            }
    ...
    function(t) {
        ...
        return function(t, e, i, s) {
            if (t.Velocity && t.Velocity.Utilities) {
                ...
                for (var l in n.RegisterEffect = n.RegisterUI = function(t, e) {
                    function i(t, e, i, s) {
                        var o = 0,
                            r;
                        $.each(t.nodeType ? [t] : t, (function(t, e) {
                            s && (i += t * s), r = e.parentNode, $.each(["height", "paddingTop", "paddingBottom", "marginTop", "marginBottom"], (function(t, i) {
                                o += parseFloat(n.CSS.getPropertyValue(e, i))
                            }))
                        })), n.animate(r, {
                            height: ("In" === e ? "+" : "-") + "=" + o
                        }, {
                    ...
                    return n.Redirects[t] = function(o, r, a, l, c, u) {
                        var h = a === l - 1;
                        ...
                        for (var d = 0; d < e.calls.length; d++) {
                            var p = e.calls[d],
                                f = p[0],
                                m = r.duration || e.defaultDuration || 1e3,
                                g = p[1],
                                v = p[2] || {},
                                _ = {};
                            if (_.duration = m * (g || 1), _.queue = r.queue || "", _.easing = v.easing || "ease", _.delay = parseFloat(v.delay) || 0, _._cacheValues = v._cacheValues || !0, 0 === d) {
                                if (_.delay += parseFloat(r.delay) || 0, 0 === a && (_.begin = function() {
                                    r.begin && r.begin.call(c, c);
                                    var e = t.match(/(In|Out)$/);
                                    e && "In" === e[0] && f.opacity !== s && $.each(c.nodeType ? [c] : c, (function(t, e) {
                                        n.CSS.setPropertyValue(e, "opacity", 0)
                                    })), r.animateParentHeight && e && i(c, e[0], m + _.delay, r.stagger)
                                }), null !== r.display)
                                    if (r.display !== s && "none" !== r.display) _.display = r.display;
                                    else if (/In$/.test(t)) {
                                        var y = n.CSS.Values.getDisplayType(o);
                                        _.display = "inline" === y ? "inline-block" : y
                                    }
                                r.visibility && "hidden" !== r.visibility && (_.visibility = r.visibility)
                            }
                            if (d === e.calls.length - 1) {
                                function b() {
                                    r.display !== s && "none" !== r.display || !/Out$/.test(t) || $.each(c.nodeType ? [c] : c, (function(t, e) {
                                        n.CSS.setPropertyValue(e, "display", "none")
                                    })), r.complete && r.complete.call(c, c), u && u.resolver(c || o)
                                }
                                _.complete = function() {
                                    if (e.reset) {
                                        for (var t in e.reset) {
                                            var i = e.reset[t];
                                            n.CSS.Hooks.registered[t] !== s || "string" != typeof i && "number" != typeof i || (e.reset[t] = [e.reset[t], e.reset[t]])
                                        }
                                        var r = {
                                            duration: 0,
                                            queue: !1
                                        };
                                        h && (r.complete = b), n.animate(o, e.reset, r)
                                    } else h && b()
                                }, "hidden" === r.visibility && (_.visibility = r.visibility)
                            }
                            n.animate(o, f, _)
                        }
                    }, n
                ...
                }, n.RegisterEffect.packagedEffects) n.RegisterEffect(l, n.RegisterEffect.packagedEffects[l]);
                n.RunSequence = function(t) {
                    var e = $.extend(!0, [], t);
                    e.length > 1 && ($.each(e.reverse(), (function(t, i) {
                        ...
                        if (s) {
                            var o = i.options || i.o,
                                ...
                                c = {};
                            c[a] = function() {
                                var t = s.elements || s.e,
                                    e = t.nodeType ? [t] : t;
                                l && l.call(e, e), n(i)
                            }, s.options = $.extend({}, s.options, c)
                        }
                    })), e.reverse()), n(e[0])
                }
            } else e.console && console.log("Velocity UI Pack: Velocity must be loaded first. Aborting.");
    ...
    function($) {
        $.fn.instaFilta = function(t) {
            ...
            if (s.useSynonyms)
                for (var n = 0, o = s.synonyms.length; n < o; n++) s.synonyms[n].src = s.synonyms[n].src.split(",");
            return this.each((function() {
                var t, n, o, r, a = "";
                s.scope ? (r = $(this).closest(s.scope), n = r.find(s.targets), o = r.find(s.sections)) : (n = $(s.targets), o = $(s.sections)), n.each((function() {
                    $target = $(this), original = $target.text(), $target.data("values", function(t) {
                        var e = [original],
                            i = original;
                        if (!s.useSynonyms) return e;
                        for (var n = 0, o = t.length; n < o; n++)
                            for (var r = 0; r < t[n].src.length; r++) i = i.replace(t[n].src[r], t[n].dst);
                ...
                var l = function() {
                        o.each((function() {
                            var t = $(this);
                            t.find('[data-instafilta-hide="false"]').length ? t[s.sectionsShowEffect](s.sectionsShowDuration) : t[s.sectionsHideEffect](s.sectionsHideDuration)
                        }))
                    },
                    c = function(t) {
                        var e = (t ? n.attr("data-instafilta-hide", "false") : n).filter('[data-instafilta-hide="false"]')[s.itemsShowEffect](s.itemsShowDuration);
                        return t || n.filter('[data-instafilta-hide="true"]')[s.itemsHideEffect](s.itemsHideDuration), s.hideEmptySections && l(), "function" == typeof s.onFilterComplete && s.onFilterComplete.apply(this, [e]), e
                    },
                    u = function() {
                        return c(!0)
                    };
                e = function(t) {
                    return t = s.caseSensitive ? t : t.toLowerCase(), a !== t && (a = t, t || u(), n.each((function() {
                        var e = $(this);
                        e.data("originalText") || (e.data("originalHtml", e.html()), e.data("originalText", e.data("values")[0]));
                        var i = function(t, e) {
                                for (var i = -1, n = 0; n < t.length && !((i = (s.caseSensitive ? t[n] : t[n].toLowerCase()).indexOf(e)) >= 0); n++);
                                return i
                            }(e.data("values"), t),
                            n = e.data("originalText"),
                            o = s.caseSensitive ? n : n.toLowerCase(),
                            r = null,
                            a = null;
                        i >= 0 && s.markMatches && (r = n.substring(i, i + t.length), a = n.replace(r, '<span class="' + s.matchCssClass + '">' + r + "</span>"), e.html(e.data("originalHtml").replace(n, a))), e.attr("data-instafilta-hide", s.beginsWith && 0 !== i || i < 0 ? "true" : "false")
                    })), c())
                }, i = function(t, e) {
                    return t && t.length ? ("string" == typeof t && (t = t.split(",")), n.each((function() {
                        var i = !0,
                            n = 0,
                            o = $(this),
                            r = o.data(s.categoryDataAttr);
                        if (r) {
                            r = r.split(",");
                            ...
                            e && n === t.length && (i = !1), o.html(o.data("originalText")).attr("data-instafilta-hide", i)
                        }
                    })), c()) : u()
    ...
    function(t) {
        t.fn.anystretch = function(e, i, s) {
            var n = !this.selector.length;
            return this.each((function(o) {
                var r = {
                    ...
                    a = t(this),
                    l = n ? t(".anystretch") : a.children(".anystretch"),
                    c = l.data("settings") || r,
                    u = l.data("settings"),
                    h, d, p, f, m, g;
                return i && "object" == typeof i && t.extend(c, i), i && "function" == typeof i && (s = i), t(document).ready(v), this;

                function v() {
                    if (e || a.length >= 1) {
                        var i;
                        n || a.css({
                            position: c.elPosition,
                            background: "none"
                        }), 0 == l.length ? l = t("<div />").attr("class", "anystretch").css({
                            left: 0,
                            top: 0,
                            position: n ? "fixed" : "absolute",
                            overflow: "hidden",
                            zIndex: n ? -999999 : -999998,
                            margin: 0,
                            padding: 0,
                            height: "100%",
                            width: "100%"
                        }) : l.find("img").addClass("deleteable"), i = t("<img />").css({
                            position: "absolute",
                            display: "none",
                            margin: 0,
                            padding: 0,
                            ...
                            i.css({
                                width: "auto",
                                height: "auto"
                            }), n = this.width || t(e.target).width(), o = this.height || t(e.target).height(), h = n / o, _((function() {
                                i.fadeIn(c.speed, (function() {
                                    l.find(".deleteable").remove(), "function" == typeof s && s()
                                }))
                            }))
                        })).appendTo(l), 0 == a.children(".anystretch").length && (n ? t("body").append(l) : a.append(l)), l.data("settings", c);
                        var o = "";
                        if (e) o = e;
                        else {
                            if (!a.data(c.dataName)) return;
                            o = a.data(c.dataName)
                        }
                        i.attr("src", o), t(window).resize(_)
                    }
                }
                ...
                function _(e) {
                    try {
                        g = {
                            left: 0,
                            top: 0
                        }, p = y(), (f = p / h) >= b() ? (m = (f - b()) / 2, "center" == c.positionY || c.centeredY ? t.extend(g, {
                            top: "-" + m + "px"
                        }) : "bottom" == c.positionY && t.extend(g, {
                            top: "auto",
                            bottom: "0px"
                        })) : (f = b(), m = ((p = f * h) - y()) / 2, "center" == c.positionX || c.centeredX ? t.extend(g, {
                            left: "-" + m + "px"
                        }) : "right" == c.positionX && t.extend(g, {
                            left: "auto",
                            right: "0px"
                        })), l.children("img:not(.deleteable)").width(p).height(f).filter("img").css(g)
                    } catch (t) {}
                    "function" == typeof e && e()
                }

                function y() {
                    return n ? a.width() : a.innerWidth()
                }

                function b() {
                    return n ? a.height() : a.innerHeight()
                }
            }))
        }, t.anystretch = function(e, i, s) {
            var n;
            ("onorientationchange" in window ? t(document) : t(window)).anystretch(e, i, s)
        }
    }(jQuery),

    function(t, e) {
        "use strict";
        var $ = t.jQuery || t.Zepto,
            i = 0,
            s = !1;

        function n(i, n, o, r, a) {
            var l = 0,
                c = -1,
                u = -1,
                h = !1,
            ...
            function b() {
                h = t.devicePixelRatio > 1, o = w(o), n.delay >= 0 && setTimeout((function() {
                    k(!0)
                }), n.delay), (n.delay < 0 || n.combined) && (r.e = P(n.throttle, (function(t) {
                    "resize" === t.type && (c = u = -1), k(t.all)
                })), r.a = function(t) {
                    t = w(t), o.push.apply(o, t)
                }, r.g = function() {
                    return o = $(o).filter((function() {
                        return !$(this).data(n.loadedName)
                    }))
                }, r.f = function(t) {
                ...
                }, k(), $(n.appendScroll).on("scroll." + a + " resize." + a, r.e))
            }
            ...
            function w(t) {
                ...
                t = $(t).filter((function() {
                    var t = $(this),
                        i = S(this);
                    return !t.data(n.handledName) && (t.attr(n.attribute) || t.attr(a) || t.attr(l) || c[i] !== e)
                })).data("plugin_" + n.name, i);
                for (var u = 0, h = t.length; u < h; u++) {
                    var d = $(t[u]),
                        p = S(t[u]),
                        f = d.attr(n.imageBaseAttribute) || r;
                    p === m && f && d.attr(a) && d.attr(a, I(d.attr(a), f)), c[p] === e || d.attr(l) || d.attr(l, c[p]), p === m && s && !d.attr(g) ? d.attr(g, s) : p === m || !o || d.css(y) && "none" !== d.css(y) || d.css(y, "url('" + o + "')")
                }
                return t
            }
            ...
            function k(t, e) {
                if (o.length) {
                    for (var s = e || o, r = !1, a = n.imageBase || "", l = n.srcsetAttribute, c = n.handledName, u = 0; u < s.length; u++)
                        if (t || e || x(s[u])) {
                            var h = $(s[u]),
                                d = S(s[u]),
                                p = h.attr(n.attribute),
                                f = h.attr(n.imageBaseAttribute) || a,
                                _ = h.attr(n.loaderAttribute);
                            h.data(c) || n.visibleOnly && !h.is(":visible") || !((p || h.attr(l)) && (d === m && (f + p !== h.attr(g) || h.attr(l) !== h.attr(v)) || d !== m && f + p !== h.css(y)) || _) || (r = !0, h.data(c, !0), C(h, d, f, _))
                        }
            ...
            function C(t, e, i, s) {
                ...
                if (s) {
                    var C = function() {
                        b && t.removeAttr(n.loaderAttribute), t.data(w, !0), E(d, t), setTimeout(A, 1), C = $.noop
                    };
                    t.off(f).one(f, o).one(p, C), E(s, t, (function(e) {
                        e ? (t.off(p), C()) : (t.off(f), o())
                    })) || t.trigger(f)
                } else {
                    var x = $(new Image);
                    x.one(f, o).one(p, (function() {
                        t.hide(), e === m ? t.attr(_, x.attr(_)).attr(v, x.attr(v)).attr(g, x.attr(g)) : t.css(y, "url('" + x.attr(g) + "')"), t[n.effect](n.effectTime), b && (t.removeAttr(r + " " + a + " " + u + " " + n.imageBaseAttribute), c !== _ && t.removeAttr(c)), t.data(w, !0), E(d, t), x.remove(), A()
                    }));
                    var T = (h && k ? k : t.attr(r)) || "";
                    x.attr(_, t.attr(c)).attr(v, t.attr(a)).attr(g, T ? i + T : null), x.complete && x.trigger(p)
                }
            }
            ...
            function x(t) {
                var e = t.getBoundingClientRect(),
                    i = n.scrollDirection,
                    s = n.threshold,
                    o = D() + s > e.top && -s < e.bottom,
                    r = T() + s > e.left && -s < e.right;
                return "vertical" === i ? o : ("horizontal" === i || o) && r
            }

            function T() {
                return c >= 0 ? c : c = $(t).width()
            }

            function D() {
                return u >= 0 ? u : u = $(t).height()
            }
            ...
            function P(t, e) {
                ...
                return function(r, a) {
                    ...
                    s && clearTimeout(s), l > t || !n.enableThrottle || a ? c() : s = setTimeout(c, t - l)
                }
            }

            function A() {
                --l, o.length || l || E("onFinishedAll")
            }

            function E(t, e, s) {
                return !!(t = n[t]) && (t.apply(i, [].slice.call(arguments, 1)), !0)
            }
            "event" === n.bind || s ? b() : $(t).on(p + "." + a, b)
        }
        ...
        function o(s, o) {
            ...
            return r.config = function(t, i) {
                return i === e ? a[t] : (a[t] = i, r)
            }, r.addItems = function(t) {
                return l.a && l.a("string" === $.type(t) ? $(t) : t), r
            }, r.getItems = function() {
                return l.g ? l.g() : {}
            }, r.update = function(t) {
                return l.e && l.e({}, !t), r
            }, r.force = function(t) {
                return l.f && l.f("string" === $.type(t) ? $(t) : t), r
            }, r.loadAll = function() {
                return l.e && l.e({
                    all: !0
                }, !0), r
            }, r.destroy = function() {
                return $(a.appendScroll).off("." + c, l.e), $(t).off("." + c), l = {}, e
            }, n(r, a, s, l, c), a.chainable ? s : r
        }
        $.fn.Lazy = $.fn.lazy = function(t) {
            return new o(this, t)
        }, $.Lazy = $.lazy = function(t, i, s) {
            if ($.isFunction(i) && (s = i, i = []), $.isFunction(s)) {
                t = $.isArray(t) ? t : [t], i = $.isArray(i) ? i : [i];
                for (var n = o.prototype.config, r = n._f || (n._f = {}), a = 0, l = t.length; a < l; a++)(n[t[a]] === e || $.isFunction(n[t[a]])) && (n[t[a]] = s);
    ...
    function() {
        function t(e, i, s) {
            return ("string" == typeof i ? i : i.toString()).replace(e.define || r, (function(t, i, n, o) {
                return 0 === i.indexOf("def.") && (i = i.substring(4)), i in s || (":" === n ? (e.defineParams && o.replace(e.defineParams, (function(t, e, n) {
                    s[i] = {
                        arg: e,
                        text: n
                    }
                })), i in s || (s[i] = o)) : new Function("def", "def['" + i + "']=" + o)(s)), ""
            })).replace(e.use || r, (function(i, n) {
                e.useParams && (n = n.replace(e.useParams, (function(t, e, i, n) {
                    if (s[i] && s[i].arg && n) return t = (i + ":" + n).replace(/'|\\/g, "_"), s.__exp = s.__exp || {}, s.__exp[t] = s[i].text.replace(new RegExp("(^|[^\\w$])" + s[i].arg + "([^\\w$])", "g"), "$1" + n + "$2"), e + "def.__exp['" + t + "']"
                })));
                var o = new Function("def", "return " + n)(s);
                return o ? t(e, o, s) : o
            }))
        }
        ...
        var n = {
            ...
            r = /$^/;
        i.template = function(a, l, c) {
            var u = (l = l || i.templateSettings).append ? n : o,
                h, d = 0,
                p;
            a = l.use || l.define ? t(l, a, c || {}) : a, a = ("var out='" + (l.strip ? a.replace(/(^|\r|\n)\t* +| +\t*(\r|\n|$)/g, " ").replace(/\r|\n|\t|\/\*[\s\S]*?\*\//g, "") : a).replace(/'|\\/g, "\\$&").replace(l.interpolate || r, (function(t, i) {
                return u.start + e(i) + u.end
            })).replace(l.encode || r, (function(t, i) {
                return h = !0, u.startencode + e(i) + u.end
            })).replace(l.conditional || r, (function(t, i, s) {
                return i ? s ? "';}else if(" + e(s) + "){out+='" : "';}else{out+='" : s ? "';if(" + e(s) + "){out+='" : "';}out+='"
            })).replace(l.iterate || r, (function(t, i, s, n) {
                return i ? (d += 1, p = n || "i" + d, i = e(i), "';var arr" + d + "=" + i + ";if(arr" + d + "){var " + s + "," + p + "=-1,l" + d + "=arr" + d + ".length-1;while(" + p + "<l" + d + "){" + s + "=arr" + d + "[" + p + "+=1];out+='") : "';} } out+='"
            })).replace(l.evaluate || r, (function(t, i) {
                return "';" + e(i) + "out+='"
            })) + "';return out;").replace(/\n/g, "\\n").replace(/\t/g, "\\t").replace(/\r/g, "\\r").replace(/(\s|;|\}|^|\{)out\+='';/g, "$1").replace(/\+''/g, ""), h && (l.selfcontained || !s || s._encodeHTML || (s._encodeHTML = i.encodeHTMLSource(l.doNotSkipEncoded)), a = "var encodeHTML = typeof _encodeHTML !== 'undefined' ? _encodeHTML : (" + i.encodeHTMLSource.toString() + "(" + (l.doNotSkipEncoded || "") + "));" + a);
            try {
                return new Function(l.varname, a)
            } catch (t) {
                throw "undefined" != typeof console && console.log("Could not create a template function: " + a), t
            }
        }, i.compile = function(t, e) {
            return i.template(t, null, e)
        }
    }(),
    ...
    function($) {
        var t = -1,
            ...
            s = function(t) {
                ...
                return s.each((function() {
                    ...
                    null === s ? o.push(t) : Math.floor(Math.abs(n - e)) <= 1 ? o[o.length - 1] = s.add(t) : o.push(t), n = e
                })), o
            },
            n = function(t) {
                var e = {
            ...
            o = $.fn.matchHeight = function(t) {
                ...
                if (e.remove) {
                    var i = this;
                    return this.css(e.property, ""), $.each(o._groups, (function(t, e) {
                        e.elements = e.elements.not(i)
                    })), this
                }
                return this.length <= 1 && !e.target || (o._groups.push({
                    elements: this,
                    options: e
                }), o._apply(this, e)), this
            };
        o.version = "master", o._groups = [], o._throttle = 80, o._maintainScroll = !1, o._beforeUpdate = null, o._afterUpdate = null, o._rows = s, o._parse = i, o._parseOptions = n, o._apply = function(t, e) {
            var r = n(e),
                a = $(t),
                l = [a],
                c = $(window).scrollTop(),
            ...
            return h.each((function() {
            ...
            })), h.css("display", "block"), r.byRow && !r.target && (a.each((function() {
                var t = $(this),
                    e = t.css("display");
                ...
                if (r.target) n = r.target.outerHeight(!1);
                    ...
                    s.each((function() {
                        ...
                        i[r.property] = "", t.css(i), t.outerHeight(!1) > n && (n = t.outerHeight(!1)), t.css("display", "")
                    }))
                }
                s.each((function() {
                    var t = $(this),
            ...
            })), o._maintainScroll && $(window).scrollTop(c / u * $("html").outerHeight(!0)), this
        ...
        var r = function(t) {
            o._beforeUpdate && o._beforeUpdate(t, o._groups), $.each(o._groups, (function() {
        ...
        }, $(o._applyDataApi), $(window).bind("load", (function(t) {
            o._update(!1, t)
        ...
        t.extend(t.fn, {
            validate: function(e) {
                if (this.length) {
                    ...
                    return i || (this.attr("novalidate", "novalidate"), i = new t.validator(e, this[0]), t.data(this[0], "validator", i), i.settings.onsubmit && ((e = this.find("input, button")).filter(".cancel").click((function() {
                        i.cancelSubmit = !0
            ...
            rules: function(e, i) {
                ...
                if (e) {
                    ...
                    switch (e) {
                        case "add":
                            t.extend(r, t.validator.normalizeRule(i)), o[s.name] = r, i.messages && (n.messages[s.name] = t.extend(n.messages[s.name], i.messages));
                            break;
                        case "remove":
                ...
                return (s = t.validator.normalizeRules(t.extend({}, t.validator.metadataRules(s), t.validator.classRules(s), t.validator.attributeRules(s), t.validator.staticRules(s)), s)).required && (n = s.required, delete s.required, s = t.extend({
                    required: n
                }, s)), s
            }
        }), t.extend(t.expr[":"], {
            ...
            prototype: {
                ...
                elements: function() {
                    ...
                    return t(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, [disabled]").not(this.settings.ignore).filter((function() {
                        return !this.name && e.settings.debug && window.console && console.error("%o has no name assigned", this), !(this.name in i || !e.objectLength(t(this).rules())) && (i[this.name] = !0)
                    }))
                },
                clean: function(e) {
                    return t(e)[0]
                ...
                check: function(e) {
                    ...
                    for (n in i) {
                        ...
                        try {
                            var r = t.validator.methods[n].call(this, e.value.replace(/\r/g, ""), e, o.parameters);
                            if ("dependency-mismatch" == r) s = !0;
                            else {
            ...
            attributeRules: function(e) {
                var i = {};
                for (var s in e = t(e), t.validator.methods) {
                    var n;
            ...
            addMethod: function(e, i, s) {
                t.validator.methods[e] = i, t.validator.messages[e] = null != s ? s : t.validator.messages[e], i.length < 3 && t.validator.addClassRules(e, t.validator.normalizeRule(e))
            },
            methods: {
                ...
                remote: function(e, i, s) {
                    ...
                    return r[i.name] = e, t.ajax(t.extend(!0, {
                        ...
                        success: function(s) {
                            ...
                            } else a = {}, s = s || o.defaultMessage(i, "remote"), a[i.name] = n.message = t.isFunction(s) ? s(e) : s, o.showErrors(a);
                ...
                creditcard: function(t, e) {
                    ...
                    for (var i = 0, s = 0, n = !1, o = (t = t.replace(/\D/g, "")).length - 1; o >= 0; o--) s = t.charAt(o), s = parseInt(s, 10), n && (s *= 2) > 9 && (s -= 9), i += s, n = !n;
                    return i % 10 == 0
                },
                ...
                equalTo: function(e, i, s) {
                    return e == (s = t(s).unbind(".validate-equalTo").bind("blur.validate-equalTo", (function() {
                        t(i).valid()
                    }))).val()
                }
            }
    ...
    jQuery(window).on("load", (function() {
        if (jQuery(".select").selectric({disableOnMobile: !1,nativeOnMobile: !1}),jQuery(".mtch").matchHeight(), "martin.local" === jQuery(location).attr("hostname")) var t = "http://martin.local/mccalls.co.uk/mccalls-craft/public/";
        else var t = "./";
    })),
    ...
    function(t) {
        ...
        t.cleanData = function(e) {
            ...
            function() {
                ...
                t.position = {
                    ...
                    return v = s(_), _[0].preventDefault && (n.at = "left top"), p = v.width, f = v.height, m = v.offset, g = t.extend({}, m), t.each(["my", "at"], (function() {
                        ...
                        1 === i.length && (i = a.test(i[0]) ? i.concat(["center"]) : l.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = a.test(i[0]) ? i[0] : "center", i[1] = l.test(i[1]) ? i[1] : "center", t = c.exec(i[0]), e = c.exec(i[1]), k[this] = [t ? t[0] : 0, e ? e[0] : 0], n[this] = [u.exec(i[0])[0], u.exec(i[1])[0]]
                    })), 1 === w.length && (w[1] = w[0]), "right" === n.at[0] ? g.left += p : "center" === n.at[0] && (g.left += p / 2), "bottom" === n.at[1] ? g.top += f : "center" === n.at[1] && (g.top += f / 2), h = e(k.at, p, f), g.left += h[0], g.top += h[1], this.each((function() {
                        var s, a, l = t(this),
                            c = l.outerWidth(),
                            u = l.outerHeight(),
                            d = i(this, "marginLeft"),
                            v = i(this, "marginTop"),
                            C = c + d + i(this, "marginRight") + b.width,
                            x = u + v + i(this, "marginBottom") + b.height,
                            T = t.extend({}, g),
                            D = e(k.my, l.outerWidth(), l.outerHeight());
                        "right" === n.my[0] ? T.left -= c : "center" === n.my[0] && (T.left -= c / 2), "bottom" === n.my[1] ? T.top -= u : "center" === n.my[1] && (T.top -= u / 2), T.left += D[0], T.top += D[1], s = {
                            marginLeft: d,
                            marginTop: v
                            ...
                            c > p && p > r(e + i) && (h.horizontal = "center"), u > f && f > r(s + a) && (h.vertical = "middle"), h.important = o(r(e), r(i)) > o(r(s), r(a)) ? "horizontal" : "vertical", n.using.call(this, t, h)
                        }), l.offset(t.extend(T, {
                            using: a
                        }))
                    }))
                    ...
                    flip: {
                        left: function(t, e) {
                            var i, s, n = e.within,
                                ...
                                f = -2 * e.offset[0];
                            0 > u ? (0 > (i = t.left + d + p + f + e.collisionWidth - a - o) || r(u) > i) && (t.left += d + p + f) : h > 0 && (((s = t.left - e.collisionPosition.marginLeft + d + p + f - l) > 0 || h > r(s)) && (t.left += d + p + f))
                        },
                        top: function(t, e) {
                            var i, s, n = e.within,
                                ...
                                d, p = "top" === e.my[1] ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0,
                                f = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0,
                                m = -2 * e.offset[1];
                            0 > u ? (0 > (s = t.top + p + f + m + e.collisionHeight - a - o) || r(u) > s) && (t.top += p + f + m) : h > 0 && (((i = t.top - e.collisionPosition.marginTop + p + f + m - l) > 0 || h > r(i)) && (t.top += p + f + m))
                        }
                    },
                    flipfit: {
                        left: function() {
            ...
            var n, o, r, a, l, c = i.nodeName.toLowerCase();
            return "area" === c ? (o = (n = i.parentNode).name, !(!i.href || !o || "map" !== n.nodeName.toLowerCase()) && ((r = t("img[usemap='#" + o + "']")).length > 0 && r.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(c) ? (a = !i.disabled) && ((l = t(i).closest("fieldset")[0]) && (a = !l.disabled)) : a = "a" === c && i.href || s, a && t(i).is(":visible") && e(t(i)))
        }, t.extend(t.expr[":"], {
        ...
        t(document).on("mouseup", (function() {
            ...
            drag: function(e, i, s) {
                var n, o, r, a, l, c, u, h, d, p, f = s.options,
                    m = f.snapTolerance,
                    g = i.offset.left,
                    v = g + s.helperProportions.width,
                    _ = i.offset.top,
                    y = _ + s.helperProportions.height;
                for (d = s.snapElements.length - 1; d >= 0; d--) c = (l = s.snapElements[d].left - s.margins.left) + s.snapElements[d].width, h = (u = s.snapElements[d].top - s.margins.top) + s.snapElements[d].height, l - m > v || g > c + m || u - m > y || _ > h + m || !t.contains(s.snapElements[d].item.ownerDocument, s.snapElements[d].item) ? (s.snapElements[d].snapping && s.options.snap.release && s.options.snap.release.call(s.element, e, t.extend(s._uiHash(), {
                    snapItem: s.snapElements[d].item
                })), s.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (n = m >= Math.abs(u - y), o = m >= Math.abs(h - _), r = m >= Math.abs(l - v), a = m >= Math.abs(c - g), n && (i.position.top = s._convertPositionTo("relative", {
                    ...
                    top: 0,
                    left: c
                }).left)), p = n || o || r || a, "outer" !== f.snapMode && (n = m >= Math.abs(u - _), o = m >= Math.abs(h - y), r = m >= Math.abs(l - g), a = m >= Math.abs(c - v), n && (i.position.top = s._convertPositionTo("relative", {
                    top: u,
                    left: 0
                }).top), o && (i.position.top = s._convertPositionTo("relative", {
        ...
        var h = t.ui.intersect = function() {
            ...
            return function(e, i, s, n) {
                ...
                switch (s) {
                    ...
                    case "pointer":
                        return t(n.pageY, u, i.proportions().height) && t(n.pageX, c, i.proportions().width);
                    case "touch":
        ...
        t.ui.ddmanager = {
            ...
            _mouseStop: function(e) {
                ...
                var i, s, n, o, r, a, l, c = this.options,
                    u = this;
                return this._helper && (n = (s = (i = this._proportionallyResizeElements).length && /textarea/i.test(i[0].nodeName)) && this._hasScroll(i[0], "left") ? 0 : u.sizeDiff.height, o = s ? 0 : u.sizeDiff.width, r = {
                    width: u.helper.width() - o,
                    height: u.helper.height() - n
                }, a = parseFloat(u.element.css("left")) + (u.position.left - u.originalPosition.left) || null, l = parseFloat(u.element.css("top")) + (u.position.top - u.originalPosition.top) || null, c.animate || this.element.css(t.extend(r, {
                    top: l,
                    left: a
            ...
            _respectSize: function(t) {
                var e = this._vBoundaries,
                    ...
                    c = /sw|nw|w/.test(i),
                    u = /nw|ne|n/.test(i);
                return o && (t.width = e.minWidth), r && (t.height = e.minHeight), s && (t.width = e.maxWidth), n && (t.height = e.maxHeight), o && c && (t.left = a - e.minWidth), s && c && (t.left = a - e.maxWidth), r && u && (t.top = l - e.minHeight), n && u && (t.top = l - e.maxHeight), t.width || t.height || t.left || !t.top ? t.width || t.height || t.top || !t.left || (t.left = null) : t.top = null, t
            },
            ...
            resize: function(e) {
                var i, s, n, o, r = t(this).resizable("instance"),
                    ...
                    p = !0;
                d[0] !== document && /static/.test(d.css("position")) && (h = l), c.left < (r._helper ? l.left : 0) && (r.size.width = r.size.width + (r._helper ? r.position.left - l.left : r.position.left - h.left), u && (r.size.height = r.size.width / r.aspectRatio, p = !1), r.position.left = a.helper ? l.left : 0), c.top < (r._helper ? l.top : 0) && (r.size.height = r.size.height + (r._helper ? r.position.top - l.top : r.position.top), u && (r.size.width = r.size.height * r.aspectRatio, p = !1), r.position.top = r._helper ? l.top : 0), n = r.containerElement.get(0) === r.element.parent().get(0), o = /relative|absolute/.test(r.containerElement.css("position")), n && o ? (r.offset.left = r.parentData.left + r.position.left,
            ...
            resize: function() {
                var e, i = t(this).resizable("instance"),
                    ...
                    c = l[0] || 1,
                    u = l[1] || 1,
                    h = Math.round((n.width - o.width) / c) * c,
                ...
                if (this.dragged = !0, !this.options.disabled) {
                    ...
                    return o > a && (i = a, a = o, o = i), r > l && (i = l, l = r, r = i), this.helper.css({
                        ...
                        var i = t.data(this, "selectable-item"),
                            c = !1,
                            u = {};
                        i && i.element !== s.element[0] && (u.left = i.left + s.elementPos.left, u.right = i.right + s.elementPos.left, u.top = i.top + s.elementPos.top, u.bottom = i.bottom + s.elementPos.top, "touch" === n.tolerance ? c = !(u.left > a || o > u.right || u.top > l || r > u.bottom) : "fit" === n.tolerance && (c = u.left > o && a > u.right && u.top > r && l > u.bottom), c ? (i.selected && (s._removeClass(i.$element, "ui-selected"), i.selected = !1), i.unselecting && (s._removeClass(i.$element, "ui-unselecting"), i.unselecting = !1), i.selecting || (s._addClass(i.$element, "ui-selecting"), i.selecting = !0, s._trigger("selecting", e, {
                            selecting: i.element
            ...
            _intersectsWith: function(t) {
                var e = this.positionAbs.left,
                    ...
                    h = "x" === this.options.axis || s + c > a && l > s + c,
            ...
            _getItemsAsjQuery: function(e) {
                ...
                if (c && e)
                    for (s = c.length - 1; s >= 0; s--)
                        for (n = (o = t(c[s], this.document[0])).length - 1; n >= 0; n--)(r = t.data(o[n], this.widgetFullName)) && r !== this && !r.options.disabled && l.push([t.isFunction(r.options.items) ? r.options.items.call(r.element) : t(r.options.items, r.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), r]);
            ...
            _refreshItems: function(e) {
                ...
                var i, s, n, o, r, a, l, c, u = this.items,
                    h = [
                ...
                if (d && this.ready)
                    for (i = d.length - 1; i >= 0; i--)
                        for (s = (n = t(d[i], this.document[0])).length - 1; s >= 0; s--)(o = t.data(n[s], this.widgetFullName)) && o !== this && !o.options.disabled && (h.push([t.isFunction(o.options.items) ? o.options.items.call(o.element[0], e, {
                            item: this.currentItem
                        }) : t(o.options.items, o.element), o]), this.containers.push(o));
                for (i = h.length - 1; i >= 0; i--)
                    for (r = h[i][1], s = 0, c = (a = h[i][0]).length; c > s; s++)(l = t(a[s])).data(this.widgetName + "-item", r), u.push({
                        item: l,
                        instance: r,
                        width: 0,
                        height: 0,
            ...
            _contactContainers: function(e) {
                var i, s, n, o, r, a, l, c, u, h, d = null,
                    p = null;
                ...
                if (d)
                    if (1 === this.containers.length) this.containers[p].containerCache.over || (this.containers[p]._trigger("over", e, this._uiHash(this)), this.containers[p].containerCache.over = 1);
                        ...
                        for (n = 1e4, o = null, r = (u = d.floating || this._isFloating(this.currentItem)) ? "left" : "top", a = u ? "width" : "height", h = u ? "pageX" : "pageY", s = this.items.length - 1; s >= 0; s--) t.contains(this.containers[p].element[0], this.items[s].item[0]) && this.items[s].item[0] !== this.currentItem[0] && (l = this.items[s].item.offset()[r], c = !1, e[h] - l > this.items[s][a] / 2 && (c = !0), n > Math.abs(e[h] - l) && (n = Math.abs(e[h] - l), o = this.items[s], this.direction = c ? "up" : "down"));
            ...
            _animate: function(t, e, i) {
                ...
                return "number" == typeof h && (o = h), "string" == typeof h && (n = h), n = n || h.easing || u.easing, o = o || h.duration || u.duration, e.length ? t.length ? (s = t.show().outerHeight(), e.animate(this.hideProps, {
                    duration: o,
                    easing: n,
                    step: function(t, e) {
                        e.now = Math.round(t)
            ...
            _destroy: function() {
                var e, i = this.element.find(".ui-menu-item").removeAttr("role aria-disabled").children(".ui-menu-item-wrapper").removeUniqueId().removeAttr("tabIndex role aria-haspopup");
        ...
        t.widget("ui.controlgroup", {
            ...
            _callChildMethod: function(e) {
                this.childWidgets.each((function() {
                    var i, s = t(this).data("ui-controlgroup-data");
                    s && s[e] && s[e]()
                }))
            },
            ...
            _optionDatepicker: function(e, i, s) {
                var n, o, a, l, c = this._getInst(e);
                return 2 === arguments.length && "string" == typeof i ? "defaults" === i ? t.extend({}, t.datepicker._defaults) : c ? "all" === i ? t.extend({}, c.settings) : this._get(c, i) : null : (n = i || {}, "string" == typeof i && ((n = {})[i] = s), void(c && (this._curInst === c && this._hideDatepicker(), o = this._getDateDatepicker(e, !0), a = this._getMinMaxDate(c, "min"), l = this._getMinMaxDate(c, "max"), r(c.settings, n), null !== a && void 0 !== n.dateFormat && void 0 === n.minDate && (c.settings.minDate = this._formatDate(c, a)), null !== l && void 0 !== n.dateFormat && void 0 === n.maxDate && (c.settings.maxDate = this._formatDate(c, l)), "disabled" in n && (n.disabled ? this._disableDatepicker(e) : this._enableDatepicker(e)), this._attachments(t(e), c), this._autoSize(c), this._setDate(c, o), this._updateAlternate(c), this._updateDatepicker(c))))
            },
            ...
            _showDatepicker: function(e) {
                ...
                ("input" !== (e = e.target || e).nodeName.toLowerCase() && (e = t("input", e.parentNode)[0]), t.datepicker._isDisabledDatepicker(e) || t.datepicker._lastInput === e) || (s = t.datepicker._getInst(e), t.datepicker._curInst && t.datepicker._curInst !== s && (t.datepicker._curInst.dpDiv.stop(!0, !0), s && t.datepicker._datepickerShowing && t.datepicker._hideDatepicker(t.datepicker._curInst.input[0])), !1 !== (o = (n = t.datepicker._get(s, "beforeShow")) ? n.apply(e, [e, s]) : {}) && (r(s.settings, o), s.lastVal = null, t.datepicker._lastInput = e, t.datepicker._setDateFromField(s), t.datepicker._inDialog && (e.value = ""), t.datepicker._pos || (t.datepicker._pos = t.datepicker._findPos(e), t.datepicker._pos[1] += e.offsetHeight), a = !1, t(e).parents().each((function() {
                    ...
                    left: l.left + "px",
                    top: l.top + "px"
                }), s.inline || (c = t.datepicker._get(s, "showAnim"), u = t.datepicker._get(s, "duration"), s.dpDiv.css("z-index", i(t(e)) + 1), t.datepicker._datepickerShowing = !0, t.effects && t.effects.effect[c] ? s.dpDiv.show(c, t.datepicker._get(s, "showOptions"), u) : s.dpDiv[c || "show"](c ? u : null), t.datepicker._shouldFocusInput(s) && s.input.trigger("focus"), t.datepicker._curInst = s)))
            },
            ...
            formatDate: function(t, e, i) {
                ...
                if (e)
                    for (s = 0; t.length > s; s++)
                        if (d) "'" !== t.charAt(s) || l("'") ? h += t.charAt(s) : d = !1;
            ...
            _determineDate: function(e, i, s) {
                ...
                return (r = r && "Invalid Date" == "" + r ? s : r) && (r.setHours(0), r.setMinutes(0), r.setSeconds(0), r.setMilliseconds(0)), this._daylightSavingAdjust(r)
            },
            ...
            _generateHTML: function(t) {
                var e, i, s, n, o, r, a, l, c, u, h, d, p, f, m, g, v, _, y, b, w, k, C, x, T, D, S, I, P, A, E, M, O, F, j, H, N, z, L, W = new Date,
                    Y = this._daylightSavingAdjust(new Date(W.getFullYear(), W.getMonth(), W.getDate())),
                    R = this._get(t, "isRTL"),
                    ...
                    tt = t.drawYear;
                if (0 > J && (J += 12, tt--), Z)
                    for (e = this._daylightSavingAdjust(new Date(Z.getFullYear(), Z.getMonth() - B[0] * B[1] + 1, Z.getDate())), e = G && G > e ? G : e; this._daylightSavingAdjust(new Date(tt, J, 1)) > e;) 0 > --J && (J = 11, tt--);
                for (t.drawMonth = J, t.drawYear = tt,
                         i = this._get(t, "prevText"), i = V ? this.formatDate(i, this._daylightSavingAdjust(new Date(tt, J - $, 1)), this._getFormatConfig(t)) : i, s = this._canAdjustMonth(t, -1, tt, J) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "e" : "w") + "'>" + i + "</span></a>" : q ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "e" : "w") + "'>" + i + "</span></a>", n = this._get(t, "nextText"), n = V ? this.formatDate(n, this._daylightSavingAdjust(new Date(tt, J + $, 1)), this._getFormatConfig(t)) : n, o = this._canAdjustMonth(t, 1, tt, J) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "w" : "e") + "'>" + n + "</span></a>" : q ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + n + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "w" : "e") + "'>" + n + "</span></a>", r = this._get(t, "currentText"), a = this._get(t, "gotoCurrent") && t.currentDay ? K : Y, r = V ? this.formatDate(r, a, this._getFormatConfig(t)) : r, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", c = Q ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (R ? l : "") + (this._isInRange(t, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (R ? "" : l) + "</div>" : "", u = parseInt(this._get(t, "firstDay"), 10), u = isNaN(u) ? 0 : u, h = this._get(t, "showWeek"), d = this._get(t, "dayNames"), p = this._get(t, "dayNamesMin"), f = this._get(t, "monthNames"), m = this._get(t, "monthNamesShort"), g = this._get(t, "beforeShowDay"), v = this._get(t, "showOtherMonths"), _ = this._get(t, "selectOtherMonths"), y = this._getDefaultDate(t), b = "", k = 0; B[0] > k; k++) {
                    for (C = "", this.maxRows = 4, x = 0; B[1] > x; x++) {
                        ...
                        for (S += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + D + "'>" + (/all|left/.test(D) && 0 === k ? R ? o : s : "") + (/all|right/.test(D) && 0 === k ? R ? s : o : "") + this._generateMonthYearHeader(t, J, tt, G, Z, k > 0 || x > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", I = h ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", w = 0; 7 > w; w++) I += "<th scope='col'" + ((w + u + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[P = (w + u) % 7] + "'>" + p[P] + "</span></th>";
                        for (S += I + "</tr></thead><tbody>", A = this._getDaysInMonth(tt, J), tt === t.selectedYear && J === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, A)), E = (this._getFirstDayOfMonth(tt, J) - u + 7) % 7, M = Math.ceil((E + A) / 7), O = X && this.maxRows > M ? this.maxRows : M, this.maxRows = O, F = this._daylightSavingAdjust(new Date(tt, J, 1 - E)), j = 0; O > j; j++) {
                            for (S += "<tr>", H = h ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(F) + "</td>" : "", w = 0; 7 > w; w++) N = g ? g.apply(t.input ? t.input[0] : null, [F]) : [!0, ""], L = (z = F.getMonth() !== J) && !_ || !N[0] || G && G > F || Z && F > Z, H += "<td class='" + ((w + u + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (z ? " ui-datepicker-other-month" : "") + (F.getTime() === T.getTime() && J === t.selectedMonth && t._keyEvent || y.getTime() === F.getTime() && y.getTime() === T.getTime() ? " " + this._dayOverClass : "") + (L ? " " + this._unselectableClass + " ui-state-disabled" : "") + (z && !v ? "" : " " + N[1] + (F.getTime() === K.getTime() ? " " + this._currentClass : "") + (F.getTime() === Y.getTime() ? " ui-datepicker-today" : "")) + "'" + (z && !v || !N[2] ? "" : " title='" + N[2].replace(/'/g, "&#39;") + "'") + (L ? "" : " data-handler='selectDay' data-event='click' data-month='" + F.getMonth() + "' data-year='" + F.getFullYear() + "'") + ">" + (z && !v ? "&#xa0;" : L ? "<span class='ui-state-default'>" + F.getDate() + "</span>" : "<a class='ui-state-default" + (F.getTime() === Y.getTime() ? " ui-state-highlight" : "") + (F.getTime() === K.getTime() ? " ui-state-active" : "") + (z ? " ui-priority-secondary" : "") + "' href='#'>" + F.getDate() + "</a>") + "</td>", F.setDate(F.getDate() + 1), F = this._daylightSavingAdjust(F);
                            S += H + "</tr>"
                        }++J > 11 && (J = 0, tt++), C += S += "</tbody></table>" + (X ? "</div>" + (B[0] > 0 && x === B[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                    }
                    b += C
                }
            ...
            _generateMonthYearHeader: function(t, e, i, s, n, o, r, a) {
                ...
                if (o || !g) b += "<span class='ui-datepicker-month'>" + r[e] + "</span>";
                    ...
                    for (l = s && s.getFullYear() === i, c = n && n.getFullYear() === i, b += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", u = 0; 12 > u; u++)(!l || u >= s.getMonth()) && (!c || n.getMonth() >= u) && (b += "<option value='" + u + "'" + (u === e ? " selected='selected'" : "") + ">" + a[u] + "</option>");
                    b += "</select>"
                }
                if (_ || (y += b + (!o && g && v ? "" : "&#xa0;")), !t.yearshtml)
                    if (t.yearshtml = "", o || !v) y += "<span class='ui-datepicker-year'>" + i + "</span>";
                        ...
                        for (h = this._get(t, "yearRange").split(":"), d = (new Date).getFullYear(), p = function(t) {
                            ...
                            return isNaN(e) ? d : e
                        }, f = p(h[0]), m = Math.max(f, p(h[1] || "")), f = s ? Math.max(f, s.getFullYear()) : f, m = n ? Math.min(m, n.getFullYear()) : m, t.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; m >= f; f++) t.yearshtml += "<option value='" + f + "'" + (f === i ? " selected='selected'" : "") + ">" + f + "</option>";
            ...
            _mouseCapture: function(e) {
                ...
                return !h.disabled && (this.elementSize = {
                    ...
                    (n > i || n === i && (e === u._lastChangedValue || u.values(e) === h.min)) && (n = i, o = t(this), r = e)
                })), !1 !== (a = this._start(e, r)) && (this._mouseSliding = !0, this._handleIndex = r, this._addClass(o, null, "ui-state-active"), o.trigger("focus"), l = o.offset(), c = !t(e.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = c ? {
                    left: 0,
                    top: 0
                } : {
            ...
            _slide: function(t, e, i) {
                var s, n, o = this.value(),
                    r = this.values();
                this._hasMultipleValues() && (n = this.values(e ? 0 : 1), o = this.values(e), 2 === this.options.values.length && !0 === this.options.range && (i = 0 === e ? Math.min(n, i) : Math.max(n, i)), r[e] = i), i !== o && (!1 !== (s = this._trigger("slide", t, this._uiHash(e, i, r))) && (this._hasMultipleValues() ? this.values(e, i) : this.value(i)))
            },
            _stop: function(t, e) {
            ...
            values: function(e, i) {
                ...
                for (s = this.options.values, n = e, o = 0; s.length > o; o += 1) s[o] = this._trimAlignValue(n[o]), this._change(null, o);
                this._refreshValue()
            },
            _setOption: function(e, i) {
                var s, n = 0;
            ...
            _refreshValue: function() {
                ...
                this._hasMultipleValues() ? this.handles.each((function(s) {
                    i = (l.values(s) - l._valueMin()) / (l._valueMax() - l._valueMin()) * 100, u["horizontal" === l.orientation ? "left" : "bottom"] = i + "%", t(this).stop(1, 1)[c ? "animate" : "css"](u, a.animate), !0 === l.options.range && ("horizontal" === l.orientation ? (0 === s && l.range.stop(1, 1)[c ? "animate" : "css"]({
                        left: i + "%"
                ...
                })) : (s = this.value(), n = this._valueMin(), o = this._valueMax(), i = o !== n ? (s - n) / (o - n) * 100 : 0, u["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[c ? "animate" : "css"](u, a.animate), "min" === r && "horizontal" === this.orientation && this.range.stop(1, 1)[c ? "animate" : "css"]({
                    width: i + "%"
            ...
            _handleEvents: {
                keydown: function(e) {
                    ...
                    switch (e.keyCode) {
                        ...
                        case t.ui.keyCode.DOWN:
                        case t.ui.keyCode.LEFT:
                            if (e.preventDefault(), !this._keySliding && (this._keySliding = !0, this._addClass(t(e.target), null, "ui-state-active"), !1 === (i = this._start(e, r)))) return
                    }
            ...
            _eventHandler: function(e) {
                var i = this.options,
                    s = this.active,
                    n, o = t(e.currentTarget).closest("li"),
                    r = o[0] === s[0],
                    a = r && i.collapsible,
        ...
        t.effects = {
                ...
                function s(i) {
                    ...
                    return i = i.toLowerCase(), f(l, (function(t, o) {
                        var r, a = o.re.exec(i),
                            l = a && o.parse(a),
                            c = o.space || "rgba";
                        return l ? (r = s[c](l), s[u[c].cache] = r[u[c].cache], n = s._rgba = r._rgba, !1) : e
                ...
                p.style.cssText = "background-color:rgba(1,1,1,.5)", d.rgba = p.style.backgroundColor.indexOf("rgba") > -1, f(u, (function(t, e) {
                    ...
                    parse: function(n, r, a, l) {
                        ...
                        return r !== e && (n = [n, r, a, l], d = "array"), "string" === d ? this.parse(s(n) || o._default) : "array" === d ? (f(u.rgba.props, (function(t, e) {
                            p[e.idx] = i(n[e.idx], e)
                        })), this) : "object" === d ? (f(u, n instanceof c ? function(t, e) {
                    ...
                    transition: function(t, e) {
                        ...
                        return s = s[o.cache], f(o.props, (function(t, n) {
                            var o = n.idx,
                                ...
                                c = s[o],
                                u = h[n.type] || {};
                            null !== c && (null === r ? l[o] = c : (u.mod && (c - r > u.mod / 2 ? r += u.mod : r - c > u.mod / 2 && (r -= u.mod)), l[o] = i((c - r) * e + r, n)))
                        })), this[n](l)
                    },
                    blend: function(e) {
                    ...
                    var e, i, s = t[0] / 255,
                        ...
                        u = a + l,
                        h = .5 * u;
                    return e = l === a ? 0 : s === a ? 60 * (n - o) / c + 360 : n === a ? 60 * (o - s) / c + 120 : 60 * (s - n) / c + 240, i = 0 === c ? 0 : .5 >= h ? c / u : c / (2 - u), [Math.round(e) % 360, i, h, null == r ? 1 : r]
                    ...
                    c.fn[s] = function(s) {
                        ...
                        var n, a = t.type(s),
                            h = "array" === a || "object" === a ? s : arguments,
                            d = this[r].slice();
                        return f(o, (function(t, e) {
                            var s = h["object" === a ? t : e.idx];
                        ...
                        c.fn[e] || (c.fn[e] = function(n) {
                            var o, r = t.type(n),
                                ...
                                c = this[l](),
                                u = c[i.idx];
                            return "undefined" === r ? u : ("function" === r && (n = n.call(this, u), r = t.type(n)), null == n && i.empty ? this : ("string" === r && ((o = a.exec(n)) && (n = u + parseFloat(o[2]) * ("+" === o[1] ? 1 : -1))), c[i.idx] = n, this[l](c)))
                        })
                    }))
                })), c.hook = function(e) {
                    var i = e.split(" ");
            ...
            function() {
                ...
                function s(t, e) {
                    var i = e.outerWidth(),
                        s = e.outerHeight(),
                        n, o = /^rect\((-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto),?\s*(-?\d*\.?\d*px|-?\d+%|auto)\)$/.exec(t) || ["", 0, i, s, 0];
                    return {
                ...
                t.expr && t.expr.filters && t.expr.filters.animated && (t.expr.filters.animated = function(e) {
                    ...
                    effect: function() {
                        function i(e) {
                            function i() {
                                a.removeData(g), t.effects.cleanUp(a), "hide" === s.mode && a.hide(), r()
                            }
                            ...
                            var a = t(this);
                            s.mode = u.shift(), !1 === t.uiBackCompat || o ? "none" === s.mode ? (a[c](), r()) : n.call(a[0], s, i) : (a.is(":hidden") ? "hide" === c : "show" === c) ? (a[c](), r()) : n.call(a[0], s, r)
                        }
                        ...
                        return t.fx.off || !n ? c ? this[c](s.duration, l) : this.each((function() {
                            l && l.call(this)
                        })) : !1 === r ? this.each(h).each(i) : this.queue(a, h).queue(a, i)
                    },
                    show: function(t) {
                        return function(s) {
        ...
        t.effects.define("blind", "hide", (function(e, i) {
            ...
            var s, n, o, r = t(this),
                ...
                _ = 0,
                y = r.queue().length;
            for (t.effects.createPlaceholder(r), o = r.css(g), h || (h = r["top" === g ? "outerHeight" : "outerWidth"]() / 3), c && ((n = {
                opacity: 1
            })[g] = o, r.css("opacity", 0).css(g, v ? 2 * -h : 2 * h).animate(n, f, m)), l && (h /= Math.pow(2, d - 1)), (n = {})[g] = o; d > _; _++)(s = {})[g] = (v ? "-=" : "+=") + h, r.animate(s, f, m).animate(n, f, m), h = l ? 2 * h : h / 2;
            l && ((s = {
                opacity: 0
            })[g] = (v ? "-=" : "+=") + h, r.animate(s, f, m)), r.queue(i), t.effects.unshift(r, y, p + 1)
            ...
            t.effects.createPlaceholder(n), s = e.distance || n["top" === l ? "outerHeight" : "outerWidth"](!0) / 2, h[l] = c + s, r && (n.css(h), h[l] = u + s, h.opacity = 1), n.animate(h, {
                queue: !1,
                duration: e.duration,
                easing: e.easing,
                complete: i
            ...
            var o, r, a, l, c, u, h = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3,
                ...
                y = [];
            for (o = 0; h > o; o++)
                for (l = g.top + o * _, u = o - (h - 1) / 2, r = 0; d > r; r++) a = g.left + r * v, c = r - (d - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
                    position: "absolute",
                    visibility: "visible",
                    left: -r * v,
                    top: -o * _
            ...
            var s = t(this),
                ...
                a = e.size || 15,
                l = /([0-9]+)%/.exec(a),
                c, u = !!e.horizFirst ? ["right", "bottom"] : ["bottom", "right"],
                h = e.duration / 2,
                ...
                g = [p[u[0]], p[u[1]]],
                v = s.queue().length;
            l && (a = parseInt(l[1], 10) / 100 * g[r ? 0 : 1]), f.clip[u[0]] = a, m.clip[u[0]] = a, m.clip[u[1]] = 0, o && (s.cssClip(m.clip), d && d.css(t.effects.clipToBox(m)), m.clip = p), s.queue((function(i) {
                d && d.animate(t.effects.clipToBox(f), h, e.easing).animate(t.effects.clipToBox(m), h, e.easing), i()
            })).animate(f, h, e.easing).animate(m, h, e.easing).queue(i), t.effects.unshift(s, v, 4)
            ...
            t.effects.createPlaceholder(r), "show" === u && (o = v, v = _, _ = o), n = {
                from: {
                    y: v.height / g.height,
                    x: v.width / g.width
                },
            ...
            }, ("box" === d || "both" === d) && (n.from.y !== n.to.y && (v = t.effects.setTransition(r, l, n.from.y, v), _ = t.effects.setTransition(r, l, n.to.y, _)), n.from.x !== n.to.x && (v = t.effects.setTransition(r, c, n.from.x, v), _ = t.effects.setTransition(r, c, n.to.x, _))), ("content" === d || "both" === d) && n.from.y !== n.to.y && (v = t.effects.setTransition(r, a, n.from.y, v), _ = t.effects.setTransition(r, a, n.to.y, _)), p && (s = t.effects.getBaseline(p, g), v.top = (g.outerHeight - v.outerHeight) * s.y + m.top, v.left = (g.outerWidth - v.outerWidth) * s.x + m.left, _.top = (g.outerHeight - _.outerHeight) * s.y + m.top, _.left = (g.outerWidth - _.outerWidth) * s.x + m.left), r.css(v), ("content" === d || "both" === d) && (l = l.concat(["marginTop", "marginBottom"]).concat(a), c = c.concat(["marginLeft", "marginRight"]), r.find("*[width]").each((function() {
                var i = t(this),
                ...
                n.from.y !== n.to.y && (o = t.effects.setTransition(i, l, n.from.y, o), r = t.effects.setTransition(i, l, n.to.y, r)), n.from.x !== n.to.x && (o = t.effects.setTransition(i, c, n.from.x, o), r = t.effects.setTransition(i, c, n.to.x, r)), h && t.effects.saveStyle(i), i.css(o), i.animate(r, e.duration, e.easing, (function() {
            ...
            var s = t(this),
                ...
                h = 1,
                d = s.queue().length;
            for ((o || !s.is(":visible")) && (s.css("opacity", 0).show(), u = 1); l > h; h++) s.animate({
                opacity: u
            }, c, e.easing), u = 1 - u;
            s.animate({
                opacity: u
            }, c, e.easing), s.queue(i), t.effects.unshift(s, d, l + 1)
            ...
            var s = 1,
                ...
                f = {},
                m = n.queue().length;
            for (t.effects.createPlaceholder(n), d[u] = (h ? "-=" : "+=") + r, p[u] = (h ? "+=" : "-=") + 2 * r, f[u] = (h ? "-=" : "+=") + 2 * r, n.animate(d, c, e.easing); a > s; s++) n.animate(p, c, e.easing).animate(f, c, e.easing);
            n.animate(p, c, e.easing).animate(d, c / 2, e.easing).queue(i), t.effects.unshift(n, m, l + 1)
            ...
            var s, n, o = t(this),
                ...
                d = {};
            t.effects.createPlaceholder(o), s = o.cssClip(), n = o.position()[c], d[c] = (u ? -1 : 1) * h + n, d.clip = o.cssClip(), d.clip[r[l][1]] = d.clip[r[l][0]], "show" === a && (o.cssClip(d.clip), o.css(c, d[c]), d.clip = s, d[c] = n), o.animate(d, {
                queue: !1,
                duration: e.duration,
                easing: e.easing,
                complete: i
            })
        })), !1 !== t.uiBackCompat && (_ = t.effects.define("transfer", (function(e, i) {
            t(this).transfer(e, i)
        })))
    })),
    ...
    function(t) {
        ...
        var t = $(document),
            ...
            a = function(t, e) {
                var i = this;
                i.element = t, i.$element = $(t), i.state = {
        ...
        a.prototype = {
            utils: {
                ...
                replaceDiacritics: function(t) {
                    for (var e = r.length; e--;) t = t.toLowerCase().replace(r[e], o[e]);
                    return t
                },
                format: function(t) {
                    var e = arguments;
                    return ("" + t).replace(/\{(?:(\d+)|(\w+))\}/g, (function(t, i, s) {
                        return s && e[1] ? e[1][s] : e[i]
                    }))
                },
                ...
                triggerCallback: function(t, e) {
                    var s = e.element,
                        n = e.options["on" + t],
                        o = [s].concat([].slice.call(arguments).slice(1));
                    $.isFunction(n) && n.apply(s, o), $(s).trigger(i + "-" + this.toDash(t), o)
                },
            ...
            init: function(t) {
                var e = this;
                if (e.options = $.extend(!0, {}, $.fn[i].defaults, e.options, t), e.utils.triggerCallback("BeforeInit", e), e.destroy(!0), e.options.disableOnMobile && e.utils.isMobile()) e.disableOnMobile = !0;
                else {
                    ...
                    var s = $("<input/>", {
                        ...
                        l = e.$element.wrap("<div/>").parent().append(r.prepend(a), n, s),
                        c = $("<div/>", {
                    ...
                    e.elements = {
                        ...
                        label: a,
                        outerWrapper: l
                    }, e.options.nativeOnMobile && e.utils.isMobile() && (e.elements.input = void 0, c.addClass(e.classes.prefix + "-is-native"), e.$element.on("change", (function() {
                        e.refresh()
                    }))), e.$element.on(e.eventTriggers).wrap(c), e.originalTabindex = e.$element.prop("tabindex"), e.$element.prop("tabindex", -1), e.populate(), e.activate(), e.utils.triggerCallback("Init", e)
                }
            },
            activate: function() {
                var t = this,
            ...
            getClassNames: function() {
                var t = this,
                    e = t.options.customClass,
                    i = {};
                return $.each(s.split(" "), (function(s, n) {
                    var o = e.prefix + n;
                    i[n.toLowerCase()] = e.camelCase ? o : t.utils.toDash(o)
                })), i.prefix = e.prefix, i
            },
            setLabel: function() {
                var t = this,
                    e = t.options.labelBuilder;
                if (t.state.multiple) {
                    var i = $.isArray(t.state.currValue) ? t.state.currValue : [t.state.currValue];
                    i = 0 === i.length ? [0] : i;
                    var s = $.map(i, (function(e) {
                        return $.grep(t.lookupItems, (function(t) {
                            return t.index === e
                        }))[0]
                    }));
                    s = $.grep(s, (function(t) {
                        return s.length > 1 || 0 === s.length ? "" !== $.trim(t.value) : t
                    })), s = $.map(s, (function(i) {
                        return $.isFunction(e) ? e(i) : t.utils.format(e, i)
                    })), t.options.multiple.maxLabelEntries && (s.length >= t.options.multiple.maxLabelEntries + 1 ? (s = s.slice(0, t.options.multiple.maxLabelEntries)).push($.isFunction(e) ? e({
                        text: "..."
                    }) : t.utils.format(e, {
                        text: "..."
                    ...
                    t.elements.label.html($.isFunction(e) ? e(n) : t.utils.format(e, n))
                }
            },
            populate: function() {
                var t = this,
                    e = t.$element.children(),
                    i = t.$element.find("option"),
                    s = i.filter(":selected"),
                    n = i.index(s),
                    o = 0,
                    r = t.state.multiple ? [] : 0;
                s.length > 1 && t.state.multiple && (n = [], s.each((function() {
                    n.push($(this).index())
                }))), t.state.currValue = ~n ? n : r, t.state.selectedIdx = t.state.currValue, t.state.highlightedIdx = t.state.currValue, t.items = [], t.lookupItems = [], e.length && (e.each((function(e) {
                    var i = $(this);
                    if (i.is("optgroup")) {
                        var s = {
                            element: i,
                        ...
                        i.children().each((function(e) {
                            var i = $(this);
                            s.items[e] = t.getItemData(o, i, s.groupDisabled || i.prop("disabled")), t.lookupItems[o] = s.items[e], o++
                        })), t.items[e] = s
                    } else t.items[e] = t.getItemData(o, i, i.prop("disabled")), t.lookupItems[o] = t.items[e], o++
            ...
            getItemData: function(t, e, i) {
                ...
                return {
                    ...
                    text: e.html(),
                    slug: $.trim(s.utils.replaceDiacritics(e.html())),
                    alt: e.attr("data-alt"),
            ...
            getItemsMarkup: function(t) {
                var e = this,
                    i = "<ul>";
                return $.isFunction(e.options.listBuilder) && e.options.listBuilder && (t = e.options.listBuilder(t)), $.each(t, (function(t, s) {
                    void 0 !== s.label ? (i += e.utils.format('<ul class="{1}"><li class="{2}">{3}</li>', e.utils.arrayToClassname([e.classes.group, s.groupDisabled ? "disabled" : "", s.element.prop("class")]), e.classes.grouplabel, s.element.prop("label")), $.each(s.items, (function(t, s) {
                        i += e.getItemMarkup(s.index, s)
                    })), i += "</ul>") : i += e.getItemMarkup(s.index, s)
                })), i + "</ul>"
            },
            getItemMarkup: function(t, e) {
                ...
                return i.utils.format('<li data-index="{1}" class="{2}">{3}</li>', t, i.utils.arrayToClassname([e.className, t === i.items.length - 1 ? "last" : "", e.disabled ? "disabled" : "", e.selected ? "selected" : ""]), $.isFunction(s) ? i.utils.format(s(e, this.$element, t), e) : i.utils.format(s, n))
            },
            unbindEvents: function() {
                var t = this;
                t.elements.wrapper.add(t.$element).add(t.elements.outerWrapper).add(t.elements.input).off(n)
            },
            bindEvents: function() {
                var t = this;
                t.elements.outerWrapper.on("mouseenter.sl mouseleave" + n, (function(e) {
                    $(this).toggleClass(t.classes.hover, "mouseenter" === e.type), t.options.openOnHover && (clearTimeout(t.closeTimer), "mouseleave" === e.type ? t.closeTimer = setTimeout($.proxy(t.close, t), t.options.hoverIntentTimeout) : t.open())
                    ...
                    disabled: !1
                }).on("keydown" + n, $.proxy(t.handleKeys, t)).on("focusin" + n, (function(e) {
                    ...
                    var e = t.elements.input.val(),
                        i = new RegExp("^" + t.utils.escapeRegExp(e), "i");
                    clearTimeout(t.resetStr), t.resetStr = setTimeout((function() {
                        t.elements.input.val("")
                    }), t.options.keySearchTimeout), e.length && $.each(t.items, (function(e, s) {
                        if (!s.disabled) {
                            if (i.test(s.text) || i.test(s.slug)) return t.highlight(e), !1;
                            if (s.alt)
                                for (var n = s.alt.split("|"), o = 0; o < n.length && n[o]; o++)
                                    if (i.test(n[o].trim())) return t.highlight(e), !1
                        }
                    }))
                }))), t.$li.on({
                    mousedown: function(t) {
                    ...
                    click: function() {
                        return t.select($(this).data("index")), !1
                    }
                })
            },
            handleKeys: function(t) {
                var e = this,
                    i = t.which,
                    s = e.options.keys,
                    n = $.inArray(i, s.previous) > -1,
                    o = $.inArray(i, s.next) > -1,
                    r = $.inArray(i, s.select) > -1,
                    a = $.inArray(i, s.open) > -1,
                    l = e.state.highlightedIdx,
                    c = n && 0 === l || o && l + 1 === e.items.length,
                    u = 0;
                if (13 !== i && 32 !== i || t.preventDefault(), n || o) {
                    if (!e.options.allowWrap && c) return;
                    n && (u = e.utils.previousEnabledItem(e.lookupItems, l)), o && (u = e.utils.nextEnabledItem(e.lookupItems, l)), e.highlight(u)
                }
                if (r && e.state.opened) return e.select(l), void(e.state.multiple && e.options.multiple.keepMenuOpen || e.close());
            ...
            isInViewport: function() {
                ...
                if (!0 === t.options.forceRenderAbove) t.elements.outerWrapper.addClass(t.classes.above);
                    ...
                    var i = e.scrollTop(),
                        ...
                        o, r = n + t.elements.outerWrapper.outerHeight() + t.itemsHeight <= i + s,
                        a = n - t.itemsHeight > i,
                        l = !r && a,
                        c = !l;
                    t.elements.outerWrapper.toggleClass(t.classes.above, l), t.elements.outerWrapper.toggleClass(t.classes.below, c)
                }
            },
            detectItemVisibility: function(t) {
                var e = this,
                    i = e.$li.filter("[data-index]");
                e.state.multiple && (t = $.isArray(t) && 0 === t.length ? 0 : t, t = $.isArray(t) ? Math.min.apply(Math, t) : t);
                var s = i.eq(t).outerHeight(),
                    n = i[t].offsetTop,
                    o = e.elements.itemsScroll.scrollTop(),
                    r = n + 2 * s;
                e.elements.itemsScroll.scrollTop(r > o + e.itemsHeight ? r - e.itemsHeight : n - s < o ? n - s : o)
            },
            open: function(e) {
                var s = this;
                if (s.options.nativeOnMobile && s.utils.isMobile()) return !1;
                s.utils.triggerCallback("BeforeOpen", s), e && (e.preventDefault(), s.options.stopPropagation && e.stopPropagation()), s.state.enabled && (s.setOptionsDimensions(), $("." + s.classes.hideselect, "." + s.classes.open).children()[i]("close"), s.state.opened = !0, s.itemsHeight = s.elements.items.outerHeight(), s.itemsInnerHeight = s.elements.items.height(), s.elements.outerWrapper.addClass(s.classes.open), s.elements.input.val(""), e && "focusin" !== e.type && s.elements.input.focus(), setTimeout((function() {
                    t.on("click" + n, $.proxy(s.close, s)).on("scroll" + n, $.proxy(s.isInViewport, s))
                }), 1), s.isInViewport(), s.options.preventWindowScroll && t.on("mousewheel.sl DOMMouseScroll" + n, "." + s.classes.scroll, (function(t) {
                    var e = t.originalEvent,
                        i = $(this).scrollTop(),
                        n = 0;
                    "detail" in e && (n = -1 * e.detail), "wheelDelta" in e && (n = e.wheelDelta), "wheelDeltaY" in e && (n = e.wheelDeltaY), "deltaY" in e && (n = -1 * e.deltaY), (i === this.scrollHeight - s.itemsInnerHeight && n < 0 || 0 === i && n > 0) && t.preventDefault()
            ...
            change: function() {
                var t = this;
                t.utils.triggerCallback("BeforeChange", t), t.state.multiple ? ($.each(t.lookupItems, (function(e) {
                    t.lookupItems[e].selected = !1, t.$element.find("option").prop("selected", !1)
                })), $.each(t.state.selectedIdx, (function(e, i) {
            ...
            select: function(t) {
                ...
                if (e.utils.triggerCallback("BeforeSelect", e, t), void 0 !== t && -1 !== t && !e.lookupItems[t].disabled) {
                    if (e.state.multiple) {
                        e.state.selectedIdx = $.isArray(e.state.selectedIdx) ? e.state.selectedIdx : [e.state.selectedIdx];
                        var s = $.inArray(t, e.state.selectedIdx); - 1 !== s ? e.state.selectedIdx.splice(s, 1) : e.state.selectedIdx.push(t), i.removeClass("selected").filter((function(t) {
                            return -1 !== $.inArray(t, e.state.selectedIdx)
                        })).addClass("selected")
            ...
            destroy: function(t) {
                var e = this;
                e.state && e.state.enabled && (e.elements.items.add(e.elements.wrapper).add(e.elements.input).remove(), t || e.$element.removeData(i).removeData("value"), e.$element.prop("tabindex", e.originalTabindex).off(n).off(e.eventTriggers).unwrap().unwrap(), e.state.enabled = !1)
            }
        }, $.fn[i] = function(t) {
            return this.each((function() {
                var e = $.data(this, i);
                e && !e.disableOnMobile ? "string" == typeof t && e[t] ? e[t]() : e.init(t) : $.data(this, i, new a(this, t))
            }))
        }, $.fn[i].defaults = {
            onChange: function(t) {
                $(t).change()
